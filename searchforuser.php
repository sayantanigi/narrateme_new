...
<section id="main">
	...
	<section id="content">
		<div class="container Main_Container">
			...
			<div id="profile-main" class="card" style="background: #f8f8f8; margin-top: 20px !important;">
				<div class="pm-body clearfix" style="padding: 20px !important;">
					<a href="dashboard.php" class="btn btn-danger" style="background: #576042; padding: 0 20px; height: 40px; border-radius: 50px; font-size: 14px; margin-left: 10px; display: flex; align-items: center; justify-content: center; width: max-content; box-shadow: none; border: 0;">
						Back To Dashboard</a>
					<div class="pmb-block">
							...
							<div class="content">
								<form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
									...
									<div style="display: flex; flex-direction: row; height: 40px;">
										<input type="text" name="user" size="30" class="user" placeholder="Search Here With Name" style="width: 100%; height: 100%; padding: 0 10px; border-radius: 10px 0 0 10px; border: 1px solid #dddd;">
										<button class="btn btn-danger" type="submit" name="searchmem" style="border-radius: 0 10px 10px 0; box-shadow: none; background: #576042; border: 0; width: 100px;">
											<span class=" glyphicon glyphicon-search" style="width:35%;"></span>
										</button>
									</div>
								</form>
							</div>
