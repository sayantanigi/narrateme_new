...
VALUES ('" . $transantionid . "', '" . $_SESSION['first_name'] . "','" . mysqli_real_escape_string($con, $_SESSION['last_name']) . "','" . $_SESSION['country_id'] . "', '" . $_SESSION['state'] . "','" . $_SESSION['city'] . "','" . $_SESSION['address'] . "','" . $_SESSION['zip_code'] . "', '" . $_SESSION['phone_number'] . "', '" . $member_id . "')");
}
?>
								...
								if (isset($_SESSION["cart_item"])) {
									...
									<form method="post" action="https://www.paypal.com/cgi-bin/webscr" id="payment">
										...
										foreach ($_SESSION["cart_item"] as $item) {
											?>
											<p>
												<input type="hidden" name="item_name_<?php echo $cnt ?>"
													value="<?php echo $item['product_name']; ?>">
												<input type="hidden" name="item_number_<?php echo $cnt ?>"
													value="<?php echo $item["code"]; ?>">
												<input type="hidden" name="amount_<?php echo $cnt ?>"
													value="<?php echo $item["price"]; ?>">
												<input type="hidden" name="quantity_<?php echo $cnt ?>"
										...
										<input type="hidden" name="at"
											value="<?php echo $_SESSION["transantionid"] . 'trnd'; ?>">
										<input type='hidden' name='notify_url' value='http://narrateme.com/dev/ipn.php'>
										<input type='hidden' name='cancel_return'
											value='http://narrateme.com/dev/cancel.php'>
