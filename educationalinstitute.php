        ...
        <div class="container Main_Container">
            <div class="block-header">
                <h2>Welcome Back <span
                        style="color:#666; font-weight:400;"><?php echo $view['first_name'] . " " . $view['last_name'] ?></span>
                    ...
                    <div class="select">
                      ...
                      <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                        ...
                        <div class="pmbb-header">
                            <div class="panel-group" data-collapse-color="teal" id="accordionTeal" role="tablist"
                                aria-multiselectable="true">
                                <div>
                                    <h4 id="gen" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">General
                                            Information</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                                </div>
                                <div id="genbody" <?php if (@$_REQUEST['gen'] == 1 || @$_REQUEST['generalinfopanel'] == 1 || @$_REQUEST['schoolspanel'] == 1) { ?>style="display:block;" <?php } else { ?>
                                    ...
                                    <div class="panel panel-collapse" style="margin-bottom: 20px;">
                                        <div <?php if (@$_REQUEST['generalinfopanel'] != '') { ?>class="panel-heading active" <?php } else { ?>class="panel-heading" <?php } ?> role="tab" id="awardpanel">
                                            <h4 class="panel-title"> <a aria-expanded="true"
                                                    href="#accordionTeal-generalinfo" data-parent="#accordionTeal"
                                                    data-toggle="collapse" class="">Add General Information</a> </h4>
                                        </div>
                                        <div id="accordionTeal-generalinfo" <?php if (@$_REQUEST['generalinfopanel'] != '') { ?> class="collapse in" <?php } else { ?>class="collapse" <?php } ?>
                                            role="tabpanel">
                                                ...
                                                <div class="pmb-block p-10  m-b-0">
                                                    <div class="pmbb-body p-l-0">
                                                        <?php if (@$_REQUEST['editgeneralinfo'] == '') { ?>
                                                            <div class="pmbb-view">
                                                                <ul class="actions"
                                                                    style="position: relative; display: flex; align-items: center; justify-content: end;">
                                                                    <li class="dropdown open">
                                                                        <ul class="dropdown-menu dropdown-menu-right"
                                                                            style="min-width: 62px; position: relative; margin: 0;">
                                                                            <li> <a data-pmb-action="edit" href="#"
                                                                                    class="btn btn-info"
                                                                                    style="color:#FFF;">Add Info</a> </li>
                                                                        </ul>
                                                                    </li>
                                                                </ul>
                                                                <?php
                                                                if (@@$_REQUEST['addgeninfoinstructor'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return instruvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="generalinfopanel"
                                                                                value="1" />
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="insnamea" name="name">
                                                                                    </div>
                                                                                    <span id="errorinsnamea"
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    ...
                                                                                    value="instructordetsubmit">Save</button>
                                                                ...
                                                                <?php if (@@$_REQUEST['editinstructorform'] == 1) { ?>
                                                                    <div>
                                                                        <form onsubmit="return editinstruvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="generalinfopanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['instructorid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Name*</dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="instrunameedit" name="name"
                                                                                            value="<?= $fetchinstructor['name'] ?>">
                                                                                    </div>
                                                                                    <span id="errorinstrunameedit"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <textarea type="text"
                                                                                            ...
                                                                                            name="bioandinfo" id="pagedes37"
                                                                                            cols="6"
                                                                                            style="height:100px;"><?= stripslashes($fetchinstructor['bioandinfo']) ?></textarea>
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="editinstructorsubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><button class="btn btn-info btn-xs"
                                                                                            style="pointer-events: none;">Instructor</button><br>Add
                                                                                        Instructor</td>
                                                                                    <td><button class="btn btn-info btn-xs"
                                                                                            style="pointer-events: none;">Instructor</button><br>View
                                                                                        Instructor</td>
                                                                                    <th>Address</th>
                                                                                    <th>Telephone</th>
                                                                                    <th>Email</th>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                while ($viewgeneralinfo = mysqli_fetch_array($resquerygeneralinfo)) {
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><?= $viewgeneralinfo['informational_description']; ?>
                                                                                        </td>
                                                                                        <td><?= $viewgeneralinfo['school_bulletin']; ?>
                                                                                        </td>
                                                                                        <!--**For Add and View**-->

                                                                                        <td><a
                                                                                                href="educationalinstitute.php?generalinfopanel=1&addgeninfoinstructor=1&ind_id=<?= $viewgeneralinfo['ind_id'] ?>&id=<?= $viewgeneralinfo['id'] ?>"><img
                                                                                                    src="img/add.png" /></a></td>
                                                                                        <td><a
                                                                                                id="instr<?php echo $viewgeneralinfo['id'] ?>"><img
                                                                                                    src="img/show.png" /></a></td>

                                                                                        <!--**For Add and View**-->
                                                                                        <td><?= $viewgeneralinfo['address']; ?></td>
                                                                                        <td><?= $viewgeneralinfo['telephone_no']; ?>
                                                                                        </td>
                                                                                        <td><?= $viewgeneralinfo['email']; ?></td>
                                                                                        <td><?= date('jS M Y', strtotime($viewgeneralinfo['lastedit'])) ?>
                                                                                        </td>

                                                                                        <td><a
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewgeneralinfo['ind_id'] ?>&id=<?= $viewgeneralinfo['id'] ?>&editgeneralinfo=awards&accr=1&gen=1&generalinfopanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewgeneralinfo['ind_id'] ?>&id=<?= $viewgeneralinfo['id'] ?>&delgeneralinfo=val&generalinfopanel=1&gen=1"
                                                                                                style="color:#ff0000;">Delete</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <!--SUB LEVEL-->
                                                                                    <tr style="display:none; background-color:#000;"
                                                                                        id="instructor<?php echo $viewgeneralinfo['id'] ?>">
                                                                                        <td colspan="10">
                                                                                            <div style="col-sm-12">
                                                                                                <table
                                                                                                    class="table table-striped table-bordered table-advance table-hover"
                                                                                                    ...
                                                                                                    <thead>
                                                                                                        ...
                                                                                                        while ($fetchinslist = mysqli_fetch_array($sqlinstructor)) {
                                                                                                            ?>
                                                                                                            <tr>
                                                                                                                <td><?php echo $fetchinslist['name'] ?>
                                                                                                                </td>
                                                                                                                <td><?php echo $fetchinslist['course'] ?>
                                                                                                                </td>
                                                                                                                <td><?= substr(stripslashes($fetchinslist['bioandinfo']), 0, 20) ?>
                                                                                                                </td>
                                                                                                                ...
                                                                                                                <td><?= date('jS F Y', strtotime($fetchinslist['lastedit'])) ?>
                                                                                                                </td>
                                                                                                                <!--EDIT AND DELETE-->
                                                                                                                <td>
                                                                                                                    <a
                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchinslist['ind_id'] ?>&instructorid=<?= $fetchinslist['igii_id'] ?>&editinstructorform=1&accr=1&generalinfopanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                    <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchinslist['ind_id'] ?>&id=<?= $fetchinslist['igii_id'] ?>&delinstructor=val&generalinfopanel=1"
                                                                                                                        style="color:#ff0000;">Delete</a>
                                                                                                                    <!--EDIT AND DELETE-->
                                                                                                                </td>
                                                                                                            </tr>
                                                        ...
                                                        <?php } else { ?>
                                                            <form name="generalinfoform" id="generalinfoform"
                                                                onsubmit="return check9();"
                                                                action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                                style="margin-top: 15px;">
                                                                <input type="hidden" name="generalinfopanel" value="1" />
                                                                <input type="hidden" name="generalinfodid"
                                                                    value="<?= $viewgeneralinfo['id'] ?>" />
                                                                <div class="pmbb-edit" style="display:block;">
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewgeneralinfo['name'] ?>"
                                                                                    id="name" name="name"
                                                                                    placeholder="Name">
                                                                            </div>
                                                                            <span id="generalinfo_error3"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <textarea rows="5" cols="10" id="pagedes36"
                                                                                    name="informational_description"
                                                                                    class="form-control "><?php echo $viewgeneralinfo['informational_description'] ?></textarea>
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type='text' class="form-control "
                                                                                    value="<?php echo $viewgeneralinfo['school_bulletin'] ?>"
                                                                                    id="school_bulletin"
                                                                                    name="school_bulletin"
                                                                                    data-toggle="dropdown"
                                                                                    placeholder="School Bulletin">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['address'] ?>"
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['telephone_no'] ?>"
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='email' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['email'] ?>"
                                                                                    id="email" name="email"
                                                                                    data-toggle="dropdown"
                                                                                    placeholder="Email">
                                                                            </div>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['message'] ?>"
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['ip_address'] ?>"
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['website'] ?>"
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['domain_name'] ?>"
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['url'] ?>"
                                                                                    id="url" name="url"
                                                                                    data-toggle="dropdown"
                                                                                    placeholder="URL">
                                                                            </div>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    value="<?php echo $viewgeneralinfo['link_to_portal'] ?>"
                                                                                    id="link_to_portal"
                                                                                    name="link_to_portal"
                                                                                    data-toggle="dropdown"
                                                                                    placeholder="ink to Portal">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <select name="status" class="form-control">
                                                                                    <option value="1" <?php if ($viewgeneralinfo['status'] == 1) { ?>
                                                                                            selected="selected" <?php } ?>>
                                                                                        Public</option>
                                                                                    <option value="2" <?php if ($viewgeneralinfo['status'] == 2) { ?>
                                                                                            selected="selected" <?php } ?>>
                                                                                        Private</option>
                                                                                    <option value="3" <?php if ($viewgeneralinfo['status'] == 3) { ?>
                                                                                            selected="selected" <?php } ?>>
                                                                                        Friends</option>
                                                                                </select>
                                                                            </div>
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm" name="submit"
                                                                            type="submit"
                                                                            value="generalinfosubmit">Save</button>
                                                        ...
                                                        <?php } ?>
                                                        <form name="generalinfoform" id="generalinfoform"
                                                            onsubmit="return Submitgeneralinfo3();"
                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                            style="margin-top: 15px;">
                                                            <input type="hidden" name="generalinfopanel" value="1" />
                                                            <div class="pmbb-edit">
                                                                ...
                                                                <dl class="dl-horizontal">
                                                                    ...
                                                                    <dd>
                                                                        <div class="fg-line">
                                                                            <input type='text' class="form-control"
                                                                                value="" id="ip_address"
                                                                                name="ip_address" data-toggle="dropdown"
                                                                                placeholder="ip Address">
                                                                        </div>
                                                                    </dd>
                                                                </dl>
                                ...
                                <div>
                                    <h4 id="prog" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">Schools
                                            & Programs</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                                </div>
                                <div id="progbody" <?php if (@$_REQUEST['prog'] == 1 || @$_REQUEST['schoolspanel'] == 1) { ?>style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                                    ...
                                    <div class="panel panel-collapse" style="margin-bottom: 20px;">
                                        <div <?php if (@$_REQUEST['schoolspanel'] != '') { ?>class="panel-heading active"
                                            <?php } else { ?>class="panel-heading" <?php } ?> role="tab"
                                            id="awardpanel">
                                            <h4 class="panel-title"> <a aria-expanded="true" href="#accordionTeal-2"
                                                    data-parent="#accordionTeal" data-toggle="collapse" class="">Add
                                                    Schools & Programs</a> </h4>
                                        </div>
                                        <div id="accordionTeal-2" <?php if (@$_REQUEST['schoolspanel'] != '') { ?>class="collapse in" <?php } else { ?>class="collapse" <?php } ?>
                                            role="tabpanel">
                                            <div class="panel-body">
                                                <div class="pmb-block p-10  m-b-0">
                                                    <div class="pmbb-body p-l-0">
                                                        <?php if (@$_REQUEST['editschools'] == '') { ?>
                                                            <div class="pmbb-view">
                                                                ...
                                                                if (@@$_REQUEST['addcourse'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return crsvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['id'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                ...
                                                                <?php if (@@$_REQUEST['editcourseform'] == 1) { ?>
                                                                    <div>
                                                                        <form onsubmit="return editcrsvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['courseid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Courses*</dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="crsnameedit" name="crsname"
                                                                                            value="<?= $fetchcourse['crsname'] ?>">
                                                                                    </div>
                                                                                    <span id="errorcrsname"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="editcoursesubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['addcoursedetails'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return crsdetvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <textarea type="text"
                                                                                            class="form-control" id="crsdet"
                                                                                            cols="6" style="height:100px;"
                                                                                            name="crs_desc"></textarea>
                                                                                    </div>
                                                                                    <span id="errorcrsdet"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Accepted Classes and Lectures
                                                                                </dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="acceptedsuplyclasses">
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="crsdetailssubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['editcourdetform'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return crsdetedtvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['coursedetid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Description*</dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <textarea type="text"
                                                                                            class="form-control" id="crsdetedt"
                                                                                            cols="6" style="height:100px;"
                                                                                            name="crs_desc"><?= $fetchcoursedet['crs_desc'] ?></textarea>
                                                                                    </div>
                                                                                    <span id="errorcrsdetedt"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="crs_instructor"
                                                                                            value="<?= $fetchcoursedet['crs_instructor'] ?>">
                                                                                    </div>
                                                                            </dl>
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text"
                                                                                            class="form-control date-picker"
                                                                                            name="crs_schedule"
                                                                                            value="<?= date('d-m-Y', strtotime($fetchcoursedet['crs_schedule'])) ?>">
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="transferofinstitutions"
                                                                                            value="<?= $fetchcoursedet['transferofinstitutions'] ?>">
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="clsandlec"
                                                                                            value="<?= $fetchcoursedet['clsandlec'] ?>">
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="acceptedsuplyclasses"
                                                                                            value="<?= $fetchcoursedet['acceptedsuplyclasses'] ?>">
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="pastlectures"
                                                                                            value="<?= $fetchcoursedet['pastlectures'] ?>">
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="crsdetailseditsubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['addvideosofclasses'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return videoslnkvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="videosofclasses"
                                                                                            name="videosofclasses">
                                                                                    </div>
                                                                                    <span id="errorvideosofclasses"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="vdoclssubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['editvidclsform'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return videoslnkeditvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['vidclsid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Videos of classes*</dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="editvideosofclasses"
                                                                                            name="videosofclasses"
                                                                                            value="<?= $fetchvidcls['videosofclasses'] ?>">
                                                                                    </div>
                                                                                    <span id="erroreditvideosofclasses"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="vdoclseditsubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['addlinkforpastlecture'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return pstleclnkvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrrecvdosubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['editpstlnkform'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return editpstleclnkvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['pstlnkid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="editlinkforvideo"
                                                                                            name="linkforvideo"
                                                                                            value="<?= $fetchpstrec['linkforvideo'] ?>">
                                                                                    </div>
                                                                                    <span id="erroreditlnkfrrecvdo"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrrecvdoeditsubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['addlinkforvidclsandlec'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return lnkfrvidclsvalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['id'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Link to recorded video/audio*
                                                                                </dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                    ...
                                                                                    <span id="errorlnktorecvdo"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>

                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Link to live
                                                                                    camera/microphone</dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="linktolivecam">
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrpstrecvdosubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['edittwolinksform'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return lnkfrtwovalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="schoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['twolinksid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Link to recorded video/audio*
                                                                                </dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="editlinktorecvideo"
                                                                                            name="linktorecvideo"
                                                                                            value="<?= $fetch123['linktorecvideo'] ?>">
                                                                                    </div>
                                                                                    <span id="erroreditlnktorecvdo"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrpstrecvdoeditsubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th>Status</th>
                                                                                    <td><button class="btn btn-info btn-xs"
                                                                                            style="pointer-events: none;">Cirriculum</button><br>Add
                                                                                        Courses</td>
                                                                                    <td><button class="btn btn-info btn-xs"
                                                                                            style="pointer-events: none;">Cirriculum</button><br>View
                                                                                        Courses</td>
                                                                                    <th>Track Date(Add/Edit)</th>
                                                                                    <th>Action</th>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                while ($viewschools = mysqli_fetch_array($resquery2)) {
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <!--**For Add and View**-->
                                                                                        <td><a
                                                                                                href="educationalinstitute.php?schoolspanel=1&addcourse=1&ind_id=<?= $viewschools['ind_id'] ?>&id=<?= $viewschools['id'] ?>"><img
                                                                                                    src="img/add.png" /></a></td>
                                                                                        <td><a
                                                                                                id="curri<?php echo $viewschools['id'] ?>"><img
                                                                                                    src="img/show.png" /></a></td>
                                                                                        <!--**For Add and View**-->
                                                                                        <td><?= date('jS F Y', strtotime($viewschools['lastedit'])) ?>
                                                                                        </td>

                                                                                        <td><a
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewschools['ind_id'] ?>&id=<?= $viewschools['id'] ?>&prog=1&&editschools=awards&accr=1&schoolspanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewschools['ind_id'] ?>&id=<?= $viewschools['id'] ?>&prog=1&delschools=val&schoolspanel=1"
                                                                                                style="color:#ff0000;">Delete</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <!--SUB LEVEL-->
                                                                                    <tr style="display:none; background-color:#000;"
                                                                                        id="curriculum<?php echo $viewschools['id'] ?>">
                                                                                        <td colspan="10">
                                                                                            <div style="col-sm-12">
                                                                                                <table
                                                                                                    class="table table-striped table-bordered table-advance table-hover"
                                                                                                    ...
                                                                                                    <thead>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td><button
                                                                                                                    ...
                                                                                                                    style="pointer-events: none;">Course</button><br>Add
                                                                                                                Details</td>
                                                                                                            <td><button
                                                                                                                    class="btn btn-info btn-xs"
                                                                                                                    style="pointer-events: none;">Course</button><br>View
                                                                                                                Details</td>
                                                                                                            <th>Track Date(Add/Edit)
                                                                                                            </th>
                                                                                                            <th>Action</th>
                                                                                                        ...
                                                                                                        while ($fetchcourse = mysqli_fetch_array($sqlcourse)) {
                                                                                                            ?>
                                                                                                            <tr>
                                                                                                                <td><?php echo $fetchcourse['crsname'] ?>
                                                                                                                </td>

                                                                                                                <!--For Sub of the sub level add and show-->
                                                                                                                <td><a
                                                                                                                        href="educationalinstitute.php?schoolspanel=1&addcoursedetails=1&ind_id=<?= $fetchcourse['ind_id'] ?>&id=<?= $fetchcourse['isc_id'] ?>"><img
                                                                                                                            src="img/add.png" /></a>
                                                                                                                </td>
                                                                                                                <td><a
                                                                                                                        id="coud<?php echo $fetchcourse['isc_id'] ?>"><img
                                                                                                                            src="img/show.png" /></a>
                                                                                                                </td>
                                                                                                                <!--For Sub of the sub level add and show-->
                                                                                                                <td><?= date('jS F Y', strtotime($fetchcourse['lastedit'])) ?>
                                                                                                                </td>
                                                                                                                <!--EDIT AND DELETE-->
                                                                                                                <td>
                                                                                                                    <a
                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchcourse['ind_id'] ?>&courseid=<?= $fetchcourse['isc_id'] ?>&editcourseform=1&accr=1&schoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                    <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchcourse['ind_id'] ?>&id=<?= $fetchcourse['isc_id'] ?>&delcourse=val&schoolspanel=1"
                                                                                                                        style="color:#ff0000;">Delete</a>
                                                                                                                    <!--EDIT AND DELETE-->
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <!--Sub of the sub level-->
                                                                                                            <tr style="display:none; background-color:#d9a773;"
                                                                                                                id="coudetails<?php echo $fetchcourse['isc_id'] ?>">
                                                                                                                <td colspan="10">
                                                                                                                    <div
                                                                                                                        style="col-sm-12">
                                                                                                                        <table
                                                          ...
                                                          <th>Course Schedule</th>-->
                                                                                                                                    ...
                                                                                                                                    <td><button
                                                                                                                                            class="btn btn-info btn-xs"
                                                                                                                                            style="pointer-events: none;">Classes
                                                                                                                                            and
                                                                                                                                            Lectures</button><br>Add
                                                                                                                                        Videos
                                                                                                                                        Link
                                                                                                                                    </td>
                                                                                                                                    <td><button
                                                                                                                                    ...
                                                                                                                                    <td><button
                                                                                                                                            class="btn btn-info btn-xs"
                                                                                                                                            style="pointer-events: none;">Past
                                                                                                                                            Lectures</button><br>Add
                                                                                                                                        Videos
                                                                                                                                        Link
                                                                                                                                    </td>
                                                          ...
                                                          <td><?= date('d-M-Y', strtotime($fetchcoudet['crs_schedule'])) ?></td>-->
                                                                                                                                        <td><?php echo $fetchcoudet['clsandlec'] ?>
                                                                                                                                        </td>
                                                                                                                                        <!--**Add & View**[Done]-->
                                                                                                                                        <td><a
                                                                                                                                                href="educationalinstitute.php?schoolspanel=1&addvideosofclasses=1&ind_id=<?= $fetchcoudet['ind_id'] ?>&id=<?= $fetchcoudet['iscd_id'] ?>"><img
                                                                                                                                                    src="img/add.png" /></a>
                                                                                                                                        </td>
                                                                                                                                        <td><a
                                                                                                                                                id="vidcls<?php echo $fetchcoudet['iscd_id'] ?>"><img
                                                                                                                                                    src="img/show.png" /></a>
                                                                                                                                        </td>
                                                                                                                                        <!--**Add & View**[Done]-->
                                                                                                                                        <td><?php echo $fetchcoudet['pastlectures'] ?>
                                                                                                                                        </td>
                                                                                                                                        <!--**Add & View**[Done]-->
                                                                                                                                        <td><a
                                                                                                                                                href="educationalinstitute.php?schoolspanel=1&addlinkforpastlecture=1&ind_id=<?= $fetchcoudet['ind_id'] ?>&id=<?= $fetchcoudet['iscd_id'] ?>"><img
                                                                                                                                                    src="img/add.png" /></a>
                                                                                                                                        </td>
                                                                                                                                        <td><a
                                                                                                                                                id="lnkfrpstlc<?php echo $fetchcoudet['iscd_id'] ?>"><img
                                                                                                                                                    src="img/show.png" /></a>
                                                                                                                                        </td>
                                                                                                                                        <!--**Add & View**[Done]-->
                                                                                                                                        <td><?= date('jS F Y', strtotime($fetchcoudet['lastedit'])) ?>
                                                                                                                                        </td>

                                                                                                                                        <td><a
                                                                                                                                                href="educationalinstitute.php?ind_id=<?= $fetchcoudet['ind_id'] ?>&coursedetid=<?= $fetchcoudet['iscd_id'] ?>&editcourdetform=1&accr=1&schoolspanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                                                                                onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                                href="educationalinstitute.php?ind_id=<?= $fetchcoudet['ind_id'] ?>&id=<?= $fetchcoudet['iscd_id'] ?>&delcoursedetails=val&schoolspanel=1"
                                                                                                                                                style="color:#ff0000;">Delete</a>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                    <!--**Videos of classes and lectures[Course Details]**-->
                                                                                                                                    <tr style="display:none; background-color:#000;"
                                                                                                                                        id="videoclass<?php echo $fetchcoudet['iscd_id'] ?>">
                                                                                                                                        <td
                                                                                                                                            colspan="10">
                                                                                                                                            <div
                                                                                                                                                style="col-sm-12">
                                                                                                                                                <table
                                                                                                                                                    ...
                                                                                                                                                    <thead>
                                                                                                                                                        <tr>
                                                                                                                                                            ...
                                                                                                                                                            <td><button
                                                                                                                                                                    class="btn btn-info btn-xs"
                                                                                                                                                                    style="pointer-events: none;">Videos</button><br>Add
                                                                                                                                                                Link
                                                                                                                                                            </td>
                                                                                                                                                            <td><button
                                                                                                                                                                    class="btn btn-info btn-xs"
                                                                                                                                                                    style="pointer-events: none;">Videos</button><br>View
                                                                                                                                                                Link
                                                                                                                                                            </td>
                                                                                                                                                            <!--Add & View[Done]-->
                                                                                                                                                            <th>Track
                                                                                                                                                        ...
                                                                                                                                                        while ($fetchcouvide = mysqli_fetch_array($sqlcouvide)) {
                                                                                                                                                            ?>
                                                                                                                                                            <tr>
                                                                                                                                                                <td><?php echo $fetchcouvide['videosofclasses'] ?>
                                                                                                                                                                </td>
                                                                                                                                                                <!--**Add & View**[Work in progress]-->
                                                                                                                                                                <td><a
                                                                                                                                                                        href="educationalinstitute.php?schoolspanel=1&addlinkforvidclsandlec=1&ind_id=<?= $fetchcouvide['ind_id'] ?>&id=<?= $fetchcouvide['iscdv_id'] ?>"><img
                                                                                                                                                                            src="img/add.png" /></a>
                                                                                                                                                                </td>
                                                                                                                                                                <td><a
                                                                                                                                                                        id="vid123<?php echo $fetchcouvide['iscdv_id'] ?>"><img
                                                                                                                                                                            src="img/show.png" /></a>
                                                                                                                                                                </td>
                                                                                                                                                                <!--**Add & View**[Work in progress]-->
                                                                                                                                                                <td><?= date('jS F Y', strtotime($fetchcouvide['lastedit'])) ?>
                                                                                                                                                                </td>
                                                                                                                                                                <!--EDIT AND DELETE-->
                                                                                                                                                                <td>
                                                                                                                                                                    <a
                                                                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchcouvide['ind_id'] ?>&vidclsid=<?= $fetchcouvide['iscdv_id'] ?>&editvidclsform=1&accr=1&schoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                                                                    <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchcouvide['ind_id'] ?>&id=<?= $fetchcouvide['iscdv_id'] ?>&delvidlec=val&schoolspanel=1"
                                                                                                                                                                        style="color:#ff0000;">Delete</a>
                                                                                                                                                                    <!--EDIT AND DELETE-->
                                                                                                                                                                </td>
                                                                                                                                                            </tr>
                                                                                                                                                            ...
                                                                                                                                                            <tr style="display:none; background-color:#000;"
                                                                                                                                                                id="vid1234<?php echo $fetchcouvide['iscdv_id'] ?>">
                                                                                                                                                                <td
                                                                                                                                                                    colspan="10">
                                                                                                                                                                    <div
                                                                                                                                                                        style="col-sm-12">
                                                                                                                                                                        <table
                                                                                                                                                                            ...
                                                                                                                                                                            <thead>
                                                                                                                                                                                ...
                                                                                                                                                                                while ($fetchsublink = mysqli_fetch_array($sqlsublink)) {
                                                                                                                                                                                    ?>
                                                                                                                                                                                    <tr>
                                                                                                                                                                                        <td><?php echo $fetchsublink['linktorecvideo'] ?>
                                                                                                                                                                                        </td>
                                                                                                                                                                                        <td><?php echo $fetchsublink['linktolivecam'] ?>
                                                                                                                                                                                        </td>
                                                                                                                                                                                        <td><?= date('jS F Y', strtotime($fetchsublink['lastedit'])) ?>
                                                                                                                                                                                        </td>
                                                                                                                                                                                        <!--EDIT AND DELETE-->
                                                                                                                                                                                        <td>
                                                                                                                                                                                            <a
                                                                                                                                                                                                href="educationalinstitute.php?ind_id=<?= $fetchsublink['ind_id'] ?>&twolinksid=<?= $fetchsublink['iscdvr_id'] ?>&edittwolinksform=1&accr=1&schoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                                                                                            <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                                                                                href="educationalinstitute.php?ind_id=<?= $fetchsublink['ind_id'] ?>&id=<?= $fetchsublink['iscdvr_id'] ?>&deltwolinks=val&schoolspanel=1"
                                                                                                                                                                                                style="color:#ff0000;">Delete</a>
                                                                                                                                                                                            <!--EDIT AND DELETE-->
                                                                                                                                                                                        </td>
                                                                                                                                                                                    </tr>
                                                                                                                                    ...
                                                                                                                                    <tr style="display:none; background-color:#000;"
                                                                                                                                        id="linkforpastlecture<?php echo $fetchcoudet['iscd_id'] ?>">
                                                                                                                                        <td
                                                                                                                                            colspan="10">
                                                                                                                                            <div
                                                                                                                                                style="col-sm-12">
                                                                                                                                                <table
                                                                                                                                                    ...
                                                                                                                                                    <thead>
                                                                                                                                                        ...
                                                                                                                                                        while ($fetchlnkpstcrs = mysqli_fetch_array($sqllnkfrpstcrs)) {
                                                                                                                                                            ?>
                                                                                                                                                            <tr>
                                                                                                                                                                <td><?php echo $fetchlnkpstcrs['linkforvideo'] ?>
                                                                                                                                                                </td>
                                                                                                                                                                <td><?= date('jS F Y', strtotime($fetchlnkpstcrs['lastedit'])) ?>
                                                                                                                                                                </td>

                                                                                                                                                                <!--EDIT AND DELETE-->
                                                                                                                                                                <td>
                                                                                                                                                                    <a
                                                                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchlnkpstcrs['ind_id'] ?>&pstlnkid=<?= $fetchlnkpstcrs['iscdl_id'] ?>&editpstlnkform=1&accr=1&schoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                                                                    <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchlnkpstcrs['ind_id'] ?>&id=<?= $fetchlnkpstcrs['iscdl_id'] ?>&delpstlnkrecvdo=val&schoolspanel=1"
                                                                                                                                                                        style="color:#ff0000;">Delete</a>
                                                                                                                                                                    <!--EDIT AND DELETE-->
                                                                                                                                                                </td>
                                                                                                                                                            </tr>
                                                        ...
                                                        <?php } else { ?>
                                                            <form name="schoolsform" id="schoolsform"
                                                                onsubmit="return check9();"
                                                                action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                                style="margin-top: 15px;">
                                                                <input type="hidden" name="schoolspanel" value="1" />
                                                                <input type="hidden" name="schoolsdid"
                                                                    value="<?= $viewschools['id'] ?>" />
                                                                <div class="pmbb-edit" style="display:block;">
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <select class="form-control "
                                                                                    id="programedt" name="program">
                                                                                    <option value="">Select Your Option
                                                                                    </option>
                                                                                    <option value="Diploma" <?php if ($viewschools['program'] == "Diploma") { ?> selected="selected" <?php } ?>>
                                                                                        Diploma</option>
                                                                                    <option value="Certificate" <?php if ($viewschools['program'] == "Certificate") { ?> selected="selected" <?php } ?>>
                                                                                        Certificate</option>
                                                                                    <option value="Degree" <?php if ($viewschools['program'] == "Degree") { ?> selected="selected" <?php } ?>>
                                                                                        Degree</option>
                                                                                    <option value="Continuing Education"
                                                                                        <?php if ($viewschools['program'] == "Continuing Education") { ?> selected="selected"
                                                                                        <?php } ?>>Continuing Education
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <span id="prgrmerr"
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewschools['course'] ?>"
                                                                                    id="course" name="course"
                                                                                    placeholder="Course/Program Bulletin">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewschools['curiculum'] ?>"
                                                                                    name="curiculum">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <select name="status" class="form-control">
                                                                                    <option value="1" <?php if ($viewschools['status'] == 1) { ?>
                                                                                            selected="selected" <?php } ?>>
                                                                                        Public</option>
                                                                                    <option value="2" <?php if ($viewschools['status'] == 2) { ?>
                                                                                            selected="selected" <?php } ?>>
                                                                                        Private</option>
                                                                                    <option value="3" <?php if ($viewschools['status'] == 3) { ?>
                                                                                            selected="selected" <?php } ?>>
                                                                                        Friends</option>
                                                                                </select>
                                                                            </div>
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm" name="submit"
                                                                            type="submit"
                                                                            value="schoolssubmit">Save</button>
                                                                        <a href="" onclick="javascript:history.go(-1)">
                                                                            <button data-pmb-action="reset"
                                                                                class="btn btn-link btn-sm">Cancel</button>
                                                                        </a>
                                                        ...
                                                        <?php } ?>
                                                        <form name="schoolsform" id="schoolsform"
                                                            onsubmit="return Submitschools3();"
                                ...
                                <div>
                                    <h4 id="aff" class="btn btn-success"><a
                                            style="cursor:pointer; color:#FFF;">Affiliate Information</a><i
                                            class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                                </div>
                                <div id="affbody" <?php if (@$_REQUEST['aff'] == 1 || @$_REQUEST['affiliateschoolspanel'] == 1) { ?>style="display:block;" <?php } else { ?>
                                        style="display:none;" <?php } ?>>
                                    <!-- Affiliate school start--->
                                    <div class="panel panel-collapse" style="margin-bottom: 20px;">
                                        <div <?php if (@$_REQUEST['affiliateschoolspanel'] != '') { ?>
                                            class="panel-heading active"
                                            <?php } else { ?>class="panel-heading"
                                            <?php } ?> role="tab" id="awardpanel">
                                            <h4 class="panel-title"> <a aria-expanded="true" href="#accordionTeal-2aff"
                                                    data-parent="#accordionTeal" data-toggle="collapse" class="">Add
                                                    Affiliate Information</a> </h4>
                                        </div>
                                        <div id="accordionTeal-2aff" <?php if (@$_REQUEST['affiliateschoolspanel'] != '') { ?>class="collapse in"
                                            <?php } else { ?>class="collapse"
                                            <?php } ?> role="tabpanel">
                                            <div class="panel-body">
                                                <div class="pmb-block p-10  m-b-0">
                                                    <div class="pmbb-body p-l-0">
                                                        ...
                                                        <div class="pmbb-view">
                                                            ...
                                                            if (@@$_REQUEST['addcurdetailsundercur'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return crsivalde();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="affiliateschoolspanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                        value="<?= @$_REQUEST['id'] ?>" />
                                                                    <dl class="dl-horizontal">
                                                            ...
                                                            if (@@$_REQUEST['editcourseiform'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return crsiedtvalde();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="affiliateschoolspanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                        value="<?= @$_REQUEST['courseiid'] ?>" />
                                                                    <dl class="dl-horizontal">
                                                                        <dt class="p-t-10">Courses*</dt>
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    id="crsnameiedt" name="courses"
                                                                                    value="<?= $fetchpstrecii['courses'] ?>">
                                                                            </div>
                                                                            <span id="errorcrsiedt"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            name="submit" type="submit"
                                                                            value="crsiedtsubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            if (@@$_REQUEST['addcoursedetailsi'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return crsdetivalde();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="affiliateschoolspanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <textarea type="text"
                                                                                    class="form-control" id="crsdeti"
                                                                                    cols="6" style="height:100px;"
                                                                                    name="crs_desc"></textarea>
                                                                            </div>
                                                                            <span id="errorcrsdeti"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            name="submit" type="submit"
                                                                            value="crsdetailsisubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            if (@@$_REQUEST['editcourdetiform'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return crsdetedtivalde();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="affiliateschoolspanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                        value="<?= @$_REQUEST['coursedetiid'] ?>" />
                                                                    <dl class="dl-horizontal">
                                                                        <dt class="p-t-10">Description*</dt>
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <textarea type="text"
                                                                                    class="form-control" id="crsdetedti"
                                                                                    cols="6" style="height:100px;"
                                                                                    name="crs_desc"><?= $fetchcoursedeti['crs_desc'] ?></textarea>
                                                                            </div>
                                                                            <span id="errorcrsdetedti"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="crs_instructor"
                                                                                    value="<?= $fetchcoursedeti['crs_instructor'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text"
                                                                                    class="form-control date-picker"
                                                                                    name="crs_schedule"
                                                                                    value="<?= date('d-m-Y', strtotime($fetchcoursedeti['crs_schedule'])) ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="transferofinstitutions"
                                                                                    value="<?= $fetchcoursedeti['transferofinstitutions'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="clsandlec"
                                                                                    value="<?= $fetchcoursedeti['clsandlec'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="acceptedsuplyclasses"
                                                                                    value="<?= $fetchcoursedeti['acceptedsuplyclasses'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="pastlectures"
                                                                                    value="<?= $fetchcoursedeti['pastlectures'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            name="submit" type="submit"
                                                                            value="crsdetailseditisubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            if (@@$_REQUEST['addvideosofclassesi'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return videoslnkivalde();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="affiliateschoolspanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            name="submit" type="submit"
                                                                            value="vdoclsisubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            if (@@$_REQUEST['editvidclsiform'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return videoslnkeditivalde();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="affiliateschoolspanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                        value="<?= @$_REQUEST['vidclsiid'] ?>" />
                                                                    <dl class="dl-horizontal">
                                                                        <dt class="p-t-10">Videos of classes*</dt>
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    id="editvideosofclassesi"
                                                                                    name="videosofclasses"
                                                                                    value="<?= $fetchvidclsi['videosofclasses'] ?>">
                                                                            </div>
                                                                            <span id="erroreditvideosofclassesi"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            name="submit" type="submit"
                                                                            value="vdoclseditisubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            <!---->
                                                                ...
                                                                if (@@$_REQUEST['addlinkforvidclsandleci'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return lnkfrvidclsivalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="affiliateschoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrpstrecvdoisubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['edittwolinksiform'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return lnkfrtwoivalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="affiliateschoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['twolinksiid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Link to recorded video/audio*
                                                                                </dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="editlinktorecvideoi"
                                                                                            name="linktorecvideo"
                                                                                            value="<?= $fetchpstrecik['linktorecvideo'] ?>">
                                                                                    </div>
                                                                                    <span id="erroreditlnktorecvdoi"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            ...
                                                                            <dl class="dl-horizontal">
                                                                                ...
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            name="linktolivecam"
                                                                                            value="<?= $fetchpstrecik['linktolivecam'] ?>">
                                                                                    </div>
                                                                            </dl>
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrpstrecvdoeditisubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['addlinkforpastlecturei'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return pstleclnkivalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="affiliateschoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                            ...
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrrecvdoisubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                ...
                                                                if (@@$_REQUEST['editpstlnkiform'] == 1) {
                                                                    ?>
                                                                    <div>
                                                                        <form onsubmit="return editpstleclnkivalde();"
                                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                            <input type="hidden" name="affiliateschoolspanel"
                                                                                value="1" />
                                                                            <input type="hidden" name="id"
                                                                                value="<?= @$_REQUEST['pstlnkiid'] ?>" />
                                                                            <dl class="dl-horizontal">
                                                                                <dt class="p-t-10">Link for Past Lecture*</dt>
                                                                                <dd>
                                                                                    <div class="fg-line">
                                                                                        <input type="text" class="form-control"
                                                                                            id="editlinkforvideoi"
                                                                                            name="linkforvideo"
                                                                                            value="<?= $fetchpstreci['linkforvideo'] ?>">
                                                                                    </div>
                                                                                    <span id="erroreditlnkfrrecvdoi"
                                                                                        style="color:#ff0000;">&nbsp;</span>
                                                                                </dd>
                                                                            </dl>
                                                                            <div class="m-t-30">
                                                                                <button class="btn btn-primary btn-sm"
                                                                                    name="submit" type="submit"
                                                                                    value="lnkfrrecvdoeditisubmit">Save</button>
                                                                                <button data-pmb-action="reset"
                                                                                    class="btn btn-link btn-sm">Cancel</button>
                                                                            </div>
                                                                        </form>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th>Status</th>
                                                                                    <td><button class="btn btn-info btn-xs"
                                                                                            style="pointer-events: none;">Curricullum</button><br>Add
                                                                                        Course</td>
                                                                                    <td><button class="btn btn-info btn-xs"
                                                                                            style="pointer-events: none;">Curricullum</button><br>View
                                                                                        Course</td>
                                                                                    <th>Track Date(Add/Edit)</th>
                                                                                    <th>Action</th>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                while ($viewaffiliateschools = mysqli_fetch_array($resquery10aff)) {
                                                                                    ?>
                                                                                    <tr>
                                                                                        <td><?= $viewaffiliateschools['program']; ?>
                                                                                        </td>
                                                                                        <td><?= $viewaffiliateschools['course']; ?>
                                                                                        </td>
                                                                                        <td><?= $viewaffiliateschools['curriculum']; ?>
                                                                                        </td>
                                                                                        ...
                                                                                        <td><a
                                                                                                href="educationalinstitute.php?affiliateschoolspanel=1&addcurdetailsundercur=1&ind_id=<?= $viewaffiliateschools['ind_id'] ?>&id=<?= $viewaffiliateschools['id'] ?>"><img
                                                                                                    src="img/add.png" /></a></td>
                                                                                        <td><a
                                                                                                id="curricul<?php echo $viewaffiliateschools['id'] ?>"><img
                                                                                                    src="img/show.png" /></a></td>
                                                                                        <!--**For Add and View Under Curricullum**-->
                                                                                        <td><?= date('jS F Y', strtotime($viewaffiliateschools['lastedit'])) ?>
                                                                                        </td>

                                                                                        <td><a
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewaffiliateschools['ind_id'] ?>&id=<?= $viewaffiliateschools['id'] ?>&aff=1&&editaffiliateschools=awards&accr=1&affiliateschoolspanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                                onclick="return confirm('Are you sure you want to delete?');"
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewaffiliateschools['ind_id'] ?>&id=<?= $viewaffiliateschools['id'] ?>&prog=1&delaffiliateschools=val&affiliateschoolspanel=1"
                                                                                                style="color:#ff0000;">Delete</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <!--SUB LEVEL-->
                                                                                    <tr style="display:none; background-color:#576042;"
                                                                                        id="curriculumaa<?php echo $viewaffiliateschools['id'] ?>">
                                                                                            ...
                                                                                            <table
                                                                                                ...
                                                                                                <thead>
                                                                                                    ...
                                                                                                    while ($fetchcoursei = mysqli_fetch_array($sqlcoursei)) {
                                                                                                        ?>
                                                                                                        <tr>
                                                                                                            <td><?php echo $fetchcoursei['courses'] ?>
                                                                                                            </td>

                                                                                                            <!--For Sub of the sub level add and show-->
                                                                                                            <td><a
                                                                                                                    href="educationalinstitute.php?affiliateschoolspanel=1&addcoursedetailsi=1&ind_id=<?= $fetchcoursei['ind_id'] ?>&id=<?= $fetchcoursei['iascd_id'] ?>"><img
                                                                                                                        src="img/add.png" /></a>
                                                                                                            </td>
                                                                                                            <td><a
                                                                                                                    id="coudi<?php echo $fetchcoursei['iascd_id'] ?>"><img
                                                                                                                        src="img/show.png" /></a>
                                                                                                            </td>
                                                                                                            <!--For Sub of the sub level add and show-->
                                                                                                            <td><?= date('jS F Y', strtotime($fetchcoursei['lastedit'])) ?>
                                                                                                            </td>

                                                                                                            <!--EDIT AND DELETE-->
                                                                                                            <td>
                                                                                                                <a
                                                                                                                    href="educationalinstitute.php?ind_id=<?= $fetchcoursei['ind_id'] ?>&courseiid=<?= $fetchcoursei['iascd_id'] ?>&editcourseiform=1&accr=1&affiliateschoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                    href="educationalinstitute.php?ind_id=<?= $fetchcoursei['ind_id'] ?>&id=<?= $fetchcoursei['iascd_id'] ?>&delcoursei=val&affiliateschoolspanel=1"
                                                                                                                    style="color:#ff0000;">Delete</a>
                                                                                                                <!--EDIT AND DELETE-->
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        ...
                                                                                                        <!--Sub of the sub level-->
                                                                                                        <tr style="display:none; background-color:#576042;"
                                                                                                            id="coudetailsi<?php echo $fetchcoursei['iascd_id'] ?>">
                                                                                                            <td colspan="5"
                                                                                                                style="padding: 10px;">
                                                                                                                <table
                                                                                                                    class="table table-striped table-bordered table-advance table-hover"
                                                          ...
                                                          <td><?php echo $fetchcoudet['crs_instructor'] ?></td>
                                                          <td><?= date('d-M-Y', strtotime($fetchcoudet['crs_schedule'])) ?></td>-->
                                                                                                                                <td><?php echo $fetchcoudeti['clsandlec'] ?>
                                                                                                                                </td>
                                                                                                                                <!--**Add & View**[DONE]-->
                                                                                                                                <td><a
                                                                                                                                        href="educationalinstitute.php?affiliateschoolspanel=1&addvideosofclassesi=1&ind_id=<?= $fetchcoudeti['ind_id'] ?>&id=<?= $fetchcoudeti['iaccd_id'] ?>"><img
                                                                                                                                            src="img/add.png" /></a>
                                                                                                                                </td>
                                                                                                                                <td><a
                                                                                                                                        id="vidclsi<?php echo $fetchcoudeti['iaccd_id'] ?>"><img
                                                                                                                                            src="img/show.png" /></a>
                                                                                                                                </td>
                                                                                                                                <!--**Add & View**[DONE]-->
                                                                                                                                <td><?php echo $fetchcoudeti['pastlectures'] ?>
                                                                                                                                </td>
                                                                                                                                <!--**Add & View**[DONE]-->
                                                                                                                                <td><a
                                                                                                                                        href="educationalinstitute.php?affiliateschoolspanel=1&addlinkforpastlecturei=1&ind_id=<?= $fetchcoudeti['ind_id'] ?>&id=<?= $fetchcoudeti['iaccd_id'] ?>"><img
                                                                                                                                            src="img/add.png" /></a>
                                                                                                                                </td>
                                                                                                                                <td><a
                                                                                                                                        id="lnkfrpstlci<?php echo $fetchcoudeti['iaccd_id'] ?>"><img
                                                                                                                                            src="img/show.png" /></a>
                                                                                                                                </td>
                                                                                                                                <!--**Add & View**[DONE]-->
                                                                                                                                <td><?= date('jS F Y', strtotime($fetchcoudeti['lastedit'])) ?>
                                                                                                                                </td>

                                                                                                                                <td><a
                                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchcoudeti['ind_id'] ?>&coursedetiid=<?= $fetchcoudeti['iaccd_id'] ?>&editcourdetiform=1&accr=1&affiliateschoolspanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                                                                        onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchcoudeti['ind_id'] ?>&id=<?= $fetchcoudeti['iaccd_id'] ?>&delcoursedetailsi=val&affiliateschoolspanel=1"
                                                                                                                                        style="color:#ff0000;">Delete</a>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <!--**Videos of classes and lectures[Course Details][DONE]**-->
                                                                                                                            <tr style="display:none; background-color:#576042;"
                                                                                                                                id="videoclassi<?php echo $fetchcoudeti['iaccd_id'] ?>">
                                                                                                                                <td colspan="8"
                                                                                                                                    style="padding: 10px;">
                                                                                                                                    <table
                                                                                                                                        class="table table-striped table-bordered table-advance table-hover"
                                                                                                                                        ...
                                                                                                                                        <thead>
                                                                                                                                            ...
                                                                                                                                            while ($fetchcouvidei = mysqli_fetch_array($sqlcouvidei)) {
                                                                                                                                                ?>
                                                                                                                                                <tr>
                                                                                                                                                    <td><?php echo $fetchcouvidei['videosofclasses'] ?>
                                                                                                                                                    </td>

                                                                                                                                                    <!--**Add & View**[DONE]-->
                                                                                                                                                    <td><a
                                                                                                                                                            href="educationalinstitute.php?affiliateschoolspanel=1&addlinkforvidclsandleci=1&ind_id=<?= $fetchcouvidei['ind_id'] ?>&id=<?= $fetchcouvidei['iascdv_id'] ?>"><img
                                                                                                                                                                src="img/add.png" /></a>
                                                                                                                                                    </td>
                                                                                                                                                    <td><a
                                                                                                                                                            id="vid12345<?php echo $fetchcouvidei['iascdv_id'] ?>"><img
                                                                                                                                                                src="img/show.png" /></a>
                                                                                                                                                    </td>
                                                                                                                                                    <!--**Add & View**[DONE]-->
                                                                                                                                                    <td><?= date('jS F Y', strtotime($fetchcouvidei['lastedit'])) ?>
                                                                                                                                                    </td>

                                                                                                                                                    <!--EDIT AND DELETE-->
                                                                                                                                                    <td>
                                                                                                                                                        <a
                                                                                                                                                            href="educationalinstitute.php?ind_id=<?= $fetchcouvidei['ind_id'] ?>&vidclsiid=<?= $fetchcouvidei['iascdv_id'] ?>&editvidclsiform=1&accr=1&affiliateschoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                                                        <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                                            href="educationalinstitute.php?ind_id=<?= $fetchcouvidei['ind_id'] ?>&id=<?= $fetchcouvidei['iascdv_id'] ?>&delvidleci=val&affiliateschoolspanel=1"
                                                                                                                                                            style="color:#ff0000;">Delete</a>
                                                                                                                                                        <!--EDIT AND DELETE-->
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                                ...
                                                                                                                                                <tr style="display:none; background-color:#576042;"
                                                                                                                                                    id="vid123456<?php echo $fetchcouvidei['iascdv_id'] ?>">
                                                                                                                                                    <td colspan="10"
                                                                                                                                                        style="padding: 10px;">
                                                                                                                                                        <table
                                                                                                                                                            class="table table-striped table-bordered table-advance table-hover"
                                                                                                                                                            ...
                                                                                                                                                            <thead>
                                                                                                                                                                ...
                                                                                                                                                                while ($fetchsublinki = mysqli_fetch_array($sqlsublinki)) {
                                                                                                                                                                    ?>
                                                                                                                                                                    <tr>
                                                                                                                                                                        <td><?php echo $fetchsublinki['linktorecvideo'] ?>
                                                                                                                                                                        </td>
                                                                                                                                                                        <td><?php echo $fetchsublinki['linktolivecam'] ?>
                                                                                                                                                                        </td>
                                                                                                                                                                        <td><?= date('jS F Y', strtotime($fetchsublinki['lastedit'])) ?>
                                                                                                                                                                        </td>
                                                                                                                                                                        <!--EDIT AND DELETE-->
                                                                                                                                                                        <td>
                                                                                                                                                                            <a
                                                                                                                                                                                href="educationalinstitute.php?ind_id=<?= $fetchsublinki['ind_id'] ?>&twolinksiid=<?= $fetchsublinki['iascdvr_id'] ?>&edittwolinksiform=1&accr=1&affiliateschoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                                                                            <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                                                                href="educationalinstitute.php?ind_id=<?= $fetchsublinki['ind_id'] ?>&id=<?= $fetchsublinki['iascdvr_id'] ?>&deltwolinksi=val&affiliateschoolspanel=1"
                                                                                                                                                                                style="color:#ff0000;">Delete</a>
                                                                                                                                                                            <!--EDIT AND DELETE-->
                                                                                                                                                                        </td>
                                                                                                                                                                    </tr>
                                                                                                                            ...
                                                                                                                            <!--**Past Recorded Lecture Link[Course Details]**-->
                                                                                                                            <tr style="display:none; background-color:#000;"
                                                                                                                                id="linkforpastlecturei<?php echo $fetchcoudeti['iaccd_id'] ?>">
                                                                                                                                <td
                                                                                                                                    colspan="8">
                                                                                                                                    <table
                                                                                                                                        class="table table-striped table-bordered table-advance table-hover"
                                                                                                                                        ...
                                                                                                                                        <thead>
                                                                                                                                            ...
                                                                                                                                            while ($fetchlnkpstcrsi = mysqli_fetch_array($sqllnkfrpstcrsi)) {
                                                                                                                                                ?>
                                                                                                                                                <tr>
                                                                                                                                                    <td><?php echo $fetchlnkpstcrsi['linkforvideo'] ?>
                                                                                                                                                    </td>
                                                                                                                                                    <td><?= date('jS F Y', strtotime($fetchlnkpstcrsi['lastedit'])) ?>
                                                                                                                                                    </td>
                                                                                                                                                    <!--EDIT AND DELETE-->
                                                                                                                                                    <td>
                                                                                                                                                        <a
                                                                                                                                                            href="educationalinstitute.php?ind_id=<?= $fetchlnkpstcrsi['ind_id'] ?>&pstlnkiid=<?= $fetchlnkpstcrsi['iacdl_id'] ?>&editpstlnkiform=1&accr=1&affiliateschoolspanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                                                        <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                                                            href="educationalinstitute.php?ind_id=<?= $fetchlnkpstcrsi['ind_id'] ?>&id=<?= $fetchlnkpstcrsi['iacdl_id'] ?>&delpstlnkrecivdo=val&affiliateschoolspanel=1"
                                                                                                                                                            style="color:#ff0000;">Delete</a>
                                                                                                                                                        <!--EDIT AND DELETE-->
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                        ...
                                                        <?php } else { ?>
                                                            <form name="affiliateschoolsform" id="affiliateschoolsform"
                                                                onsubmit="return correctionediti();"
                                                                action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                                style="margin-top: 15px;">
                                                                <input type="hidden" name="affiliateschoolspanel"
                                                                    value="1" />
                                                                <input type="hidden" name="affiliateschoolsdid"
                                                                    value="<?= $viewaffiliateschools['id'] ?>" />
                                                                <div class="pmbb-edit" style="display:block;">
                                                                    <dl class="dl-horizontal">
                                                                        <dt class="p-t-10">Academic Programs*</dt>
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                ...
                                                                                <select class="form-control "
                                                                                    id="programedit" name="program">
                                                                                    <option value="">Select Your Option
                                                                                    </option>
                                                                                    <option value="Diploma" <?php if ($viewaffiliateschools['program'] == "Diploma") { ?> selected="selected" <?php } ?>>
                                                                                        Diploma</option>
                                                                                    <option value="Certificate" <?php if ($viewaffiliateschools['program'] == "Certificate") { ?> selected="selected" <?php } ?>>
                                                                                        Certificate</option>
                                                                                    <option value="Degree" <?php if ($viewaffiliateschools['program'] == "Degree") { ?> selected="selected" <?php } ?>>
                                                                                        Degree</option>
                                                                                    <option value="Continuing Education"
                                                                                        <?php if ($viewaffiliateschools['program'] == "Continuing Education") { ?> selected="selected"
                                                                                        <?php } ?>>Continuing Education
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <span id="errorrectifyi"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewaffiliateschools['course'] ?>"
                                                                                    id="course" name="course"
                                                                                    placeholder="Course/Program Bulletin">
                                                                            </div>
                                                                        </dd>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewaffiliateschools['curriculum'] ?>"
                                                                                    name="curriculum">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <select name="status" class="form-control">
                                                                                    <option value="1" <?php if ($viewaffiliateschools['status'] == 1) { ?> selected="selected" <?php } ?>>
                                                                                        Public</option>
                                                                                    <option value="2" <?php if ($viewaffiliateschools['status'] == 2) { ?> selected="selected" <?php } ?>>
                                                                                        Private</option>
                                                                                    <option value="3" <?php if ($viewaffiliateschools['status'] == 3) { ?> selected="selected" <?php } ?>>
                                                                                        Friends</option>
                                                                                </select>
                                                                            </div>
                                                                        </dd>
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm" name="submit"
                                                                            type="submit"
                                                                            value="affiliateschoolssubmit">Save</button>
                                                                        <a href="" onclick="javascript:history.go(-1)">
                                                                            <button data-pmb-action="reset"
                                                                                class="btn btn-link btn-sm">Cancel</button>
                                                                        </a>
                                                        ...
                                                        <form name="affiliateschoolsform" id="affiliateschoolsform"
                                                            ...
                                                            <div class="pmbb-edit">
                                                                <dl class="dl-horizontal">
                                                                    ...
                                                                    <dd>
                                                                        <div class="fg-line">
                                                                            <select class="form-control " id="programee"
                                                                                name="program">
                                                                                <option value="">Select Your Option
                                                                                </option>
                                                                                <option value="Diploma">Diploma</option>
                                ...
                                <div>
                                    <h4 id="stud" class="btn btn-success"><a
                                            style="cursor:pointer; color:#FFF;">Students</a><i class="fa fa-plus-circle"
                                            aria-hidden="true"></i></h4>
                                </div>
                                <div id="studbody" <?php if (@$_REQUEST['aff'] == 1 || @$_REQUEST['cur_studentpanel'] == 1) { ?>style="display:block;"
                                    <?php } else { ?> style="display:none;"
                                    <?php } ?>>
                                    <!----   Current Student starts  ----->
                                    <div class="panel panel-collapse" style="margin-bottom: 20px;">
                                        <div <?php if (@$_REQUEST['cur_studentpanel'] != '') { ?>class="panel-heading
                                            active"
                                            <?php } else { ?>class="panel-heading"
                                            <?php } ?> role="tab" id="awardpanel">
                                            <h4 class="panel-title"> <a aria-expanded="true"
                                                    href="#accordionTeal-cur_student" data-parent="#accordionTeal"
                                                    data-toggle="collapse" class="">Add Current Students</a> </h4>
                                        </div>
                                        <div id="accordionTeal-cur_student" <?php if (@$_REQUEST['cur_studentpanel'] != '') { ?>class="collapse in"
                                            <?php } else { ?>class="collapse"
                                            <?php } ?> role="tabpanel">
                                            <div class="panel-body">
                                                <div class="pmb-block p-10  m-b-0">
                                                    <div class="pmbb-body p-l-0">
                                                        ...
                                                        <div class="pmbb-view">
                                                            ...
                                                            if (@@$_REQUEST['addtranscriptrecord'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return transcriptformvalidate();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="cur_studentpanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                        value="<?= @$_REQUEST['id'] ?>" />
                                                                    <dl class="dl-horizontal">
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <textarea type="text"
                                                                                    class="form-control" cols="6"
                                                                                    style="height:100px;" name="crsmisc"
                                                                                    id="crsmisc"></textarea>
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            name="submit" type="submit"
                                                                            value="stutranscriptrecordsubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            if (@@$_REQUEST['edittranscriptrecord'] == 1) {
                                                                ?>
                                                            <div>
                                                                <form onsubmit="return transcriptformvalidatei();"
                                                                    action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                                                    <input type="hidden" name="cur_studentpanel"
                                                                        value="1" />
                                                                    <input type="hidden" name="id"
                                                                        value="<?= @$_REQUEST['transid'] ?>" />
                                                                    <dl class="dl-horizontal">
                                                                        <dt class="p-t-10">Student ID No*</dt>
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    id="stuidi" name="stuid"
                                                                                    value="<?= $fetchtranscript['stuid'] ?>">
                                                                            </div>
                                                                            <span id="errorstuidi"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="crstaken"
                                                                                    value="<?= $fetchtranscript['crstaken'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="crsgrade"
                                                                                    value="<?= $fetchtranscript['crsgrade'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="crsattendance"
                                                                                    value="<?= $fetchtranscript['crsattendance'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <option value="Diploma" <?php if ($fetchtranscript['crsdegree'] == "Diploma") { ?> selected="selected"
                                                                                        <?php } ?>>Diploma
                                                                                    </option>
                                                                                    <option value="Certificate" <?php if ($fetchtranscript['crsdegree'] == "Certificate") { ?> selected="selected"
                                                                                        <?php } ?>>Certificate
                                                                                    </option>
                                                                                    <option value="Degree" <?php if ($fetchtranscript['crsdegree'] == "Degree") { ?> selected="selected"
                                                                                        <?php } ?>>Degree
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text"
                                                                                    class="form-control date-picker"
                                                                                    name="crsdateconferred"
                                                                                    value="<?= date('d-m-Y', strtotime($fetchtranscript['crsdateconferred'])) ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="crstranscript"
                                                                                    value="<?= $fetchtranscript['crstranscript'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    name="crsactivitytranscript"
                                                                                    value="<?= $fetchtranscript['crsactivitytranscript'] ?>">
                                                                            </div>
                                                                    </dl>
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <textarea type="text"
                                                                                    class="form-control" cols="6"
                                                                                    style="height:100px;" name="crsmisc"
                                                                                    id="crsmiscc"><?= $fetchtranscript['crsmisc'] ?></textarea>
                                                                            </div>
                                                                    </dl>
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm"
                                                                            name="submit" type="submit"
                                                                            value="stutranscriptrecordeditsubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            <dl class="dl-horizontal">
                                                                <table
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th><button class="btn btn-info btn-xs"
                                                                                    style="pointer-events: none;">Academic
                                                                                    Transcripts</button><br>Add Record
                                                                            </th>
                                                                            <th><button class="btn btn-info btn-xs"
                                                                                    style="pointer-events: none;">Academic
                                                                                    Transcripts</button><br>View Record
                                                                            </th>
                                                                            <th>Track Date(Add/Edit)</th>
                                                                            <th>Action</th>
                                                                        </tr>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <?= $viewcur_student['current_student']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?= $viewcur_student['past_student']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?= $viewcur_student['past_alumni']; ?>
                                                                            </td>

                                                                            <!--FOR ADD AND VIEW [DONE]-->
                                                                                        <td><a
                                                                                                href="educationalinstitute.php?cur_studentpanel=1&addtranscriptrecord=1&ind_id=<?= $viewcur_student['ind_id'] ?>&id=<?= $viewcur_student['id'] ?>"><img
                                                                                                    src="img/add.png" /></a></td>
                                                                                        <td><a
                                                                                                id="trans<?php echo $viewcur_student['id'] ?>"><img
                                                                                                    src="img/show.png" /></a></td>
                                                                                        <!--FOR ADD AND VIEW [DONE]-->

                                                                                        <td><?= date('jS F Y', strtotime($viewcur_student['lastedit'])) ?>
                                                                                        </td>

                                                                                        <!--FOR EDIT AND DELETE-->
                                                                                        <td><a
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewcur_student['ind_id'] ?>&id=<?= $viewcur_student['id'] ?>&editcur_student=awards&stud=1&accr=1&cur_studentpanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                                onclick="return confirm('Are you sure you want to delete?');"
                                                                                                href="educationalinstitute.php?ind_id=<?= $viewcur_student['ind_id'] ?>&id=<?= $viewcur_student['id'] ?>&delcur_student=val&cur_studentpanel=1"
                                                                                                style="color:#ff0000;">Delete</a>
                                                                                        </td>
                                                                                        <!--FOR EDIT AND DELETE-->
                                                                                    </tr>
                                                                                    <!--SUB LEVEL-->
                                                                                    <tr style="display:none; background-color:#000;"
                                                                                        id="transscript<?php echo $viewcur_student['id'] ?>">
                                                                                        <td colspan="10">
                                                                                            <div style="col-sm-12">
                                                                                                <table
                                                                                                    class="table table-striped table-bordered table-advance table-hover"
                                                                                                    ...
                                                                                                    <thead>
                                                                                                        ...
                                                                                                        while ($fetchtranscript = mysqli_fetch_array($sqltranscript)) {
                                                                                                            ?>
                                                                                                            <tr>
                                                                                                                <td><?php echo $fetchtranscript['stuid'] ?>
                                                                                                                </td>
                                                                                                                <td><?php echo $fetchtranscript['crstaken'] ?>
                                                                                                                </td>
                                                                                                                <td><?php echo $fetchtranscript['crsgrade'] ?>
                                                                                                                </td>
                                                                                                                <td><?php echo $fetchtranscript['crsattendance'] ?>
                                                                                                                </td>
                                                                                                                <td><?php echo $fetchtranscript['crsdegree'] ?>
                                                                                                                </td>
                                                                                                                <td><?= date('jS M Y', strtotime($fetchtranscript['crsdateconferred'])) ?>
                                                                                                                </td>
                                                                                                                <td><?php echo $fetchtranscript['crstranscript'] ?>
                                                                                                                </td>
                                                                                                                <!--<td><?php echo $fetchtranscript['crsactivitytranscript'] ?></td>-->
                                                                                                                <td><?= substr(stripslashes($fetchtranscript['crsmisc']), 0, 10) ?>
                                                                                                                </td>
                                                                                                                <td><?= date('jS F Y', strtotime($fetchtranscript['lastedit'])) ?>
                                                                                                                </td>

                                                                                                                <!--EDIT AND DELETE-->
                                                                                                                <td>
                                                                                                                    <a
                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchtranscript['ind_id'] ?>&transid=<?= $fetchtranscript['tra_id'] ?>&edittranscriptrecord=1&accr=1&cur_studentpanel=1">Edit</a>&nbsp;|&nbsp;
                                                                                                                    <a onclick="return confirm('Are you sure you want to delete?');"
                                                                                                                        href="educationalinstitute.php?ind_id=<?= $fetchtranscript['ind_id'] ?>&id=<?= $fetchtranscript['tra_id'] ?>&deltranscript=val&cur_studentpanel=1"
                                                                                                                        style="color:#ff0000;">Delete</a>
                                                                                                                    <!--EDIT AND DELETE-->
                                                                                                                </td>
                                                                                                            </tr>
                                                        ...
                                                        <?php } else { ?>
                                                            <form name="studentformthirdsection"
                                                                id="studentformthirdsection"
                                                                onsubmit="return studentvaldeforthrdces();"
                                                                action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                                style="margin-top: 15px;">
                                                                <input type="hidden" name="cur_studentpanel" value="1" />
                                                                <input type="hidden" name="cur_studentdid"
                                                                    value="<?= $viewcur_student['id'] ?>" />
                                                                <div class="pmbb-edit" style="display:block;">
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewcur_student['current_student'] ?>"
                                                                                    id="student_idforvalde"
                                                                                    name="current_student"
                                                                                    placeholder="Current Student">
                                                                            </div>
                                                                            <span id="cur_studenterror"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewcur_student['past_student'] ?>"
                                                                                    name="past_student"
                                                                                    placeholder="Past Student">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewcur_student['past_alumni'] ?>"
                                                                                    name="past_alumni"
                                                                                    placeholder="Past Alimni">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm" name="submit"
                                                                            type="submit"
                                                                            value="cur_studentsubmit">Save</button>
                                                                        <a href="" onclick="javascript:history.go(-1)">
                                                                            <button data-pmb-action="reset"
                                                                                class="btn btn-link btn-sm">Cancel</button>
                                                                        </a>
                                                        ...
                                                        <?php } ?>
                                                        <form name="studentformthirdsection"
                                                            id="studentformthirdsection" enctype="multipart/form-data"
                                                            onsubmit="return Submitcur_student3();"
                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                            style="margin-top: 15px;">
                                                            <input type="hidden" name="cur_studentpanel" value="1" />
                                                            <div class="pmbb-edit">
                                                                <dl class="dl-horizontal">
                                                                    ...
                                                                    <dd>
                                                                        <div class="fg-line">
                                                                            <input type="text" class="form-control"
                                                                                id="student_idforvaldei"
                                                                                name="current_student"
                                                                                placeholder="Current Student">
                                                                        </div>
                                                                        <span id="cur_studenterrori"
                                                                            style="color:#ff0000;">&nbsp;</span>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="dl-horizontal">
                                ...
                                <div>
                                    <h4 id="market" class="btn btn-success"><a
                                            style="cursor:pointer; color:#FFF;">Marketing and Promotion</a><i
                                            class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                                </div>
                                <div id="marketbody" <?php if (@$_REQUEST['aff'] == 1 || @$_REQUEST['marketpanel'] == 1) { ?>style="display:block;"
                                    <?php } else { ?> style="display:none;"
                                    <?php } ?>>
                                    <div class="panel panel-collapse" style="margin-bottom: 20px;">
                                        <div <?php if (@$_REQUEST['marketpanel'] != '') { ?>class="panel-heading active"
                                            <?php } else { ?>class="panel-heading"
                                            <?php } ?> role="tab" id="awardpanel">
                                            <h4 class="panel-title"> <a aria-expanded="true"
                                                    href="#accordionTeal-market" data-parent="#accordionTeal"
                                                    data-toggle="collapse" class="">Add Marketing and Promotion</a></h4>
                                        </div>
                                        <div id="accordionTeal-market" <?php if (@$_REQUEST['marketpanel'] != '') { ?>
                                            class="collapse in"
                                            <?php } else { ?>class="collapse"
                                            <?php } ?> role="tabpanel">
                                            <div class="panel-body">
                                                <div class="pmb-block p-10  m-b-0">
                                                    <div class="pmbb-body p-l-0">
                                                        ...
                                                        <div class="pmbb-view">
                                                            ...
                                                            <dl class="dl-horizontal">
                                                                <table
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Advertisements/Advertisement Materials
                                                                            </th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <?= $viewmarket['Advertisements']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?= $viewmarket['Marketing_Material']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?= $viewmarket['Commercials']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?= $viewmarket['Video']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?= $viewmarket['Infomercials']; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?= date('jS F Y', strtotime($viewmarket['lastedit'])) ?>
                                                                            </td>

                                                                            <td><a
                                                                                    href="educationalinstitute.php?ind_id=<?= $viewmarket['ind_id'] ?>&id=<?= $viewmarket['id'] ?>&editmarket=awards&market=1&accr=1&marketpanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                    href="educationalinstitute.php?ind_id=<?= $viewmarket['ind_id'] ?>&id=<?= $viewmarket['id'] ?>&delmarket=val&marketpanel=1"
                                                                                    style="color:#ff0000;">Delete</a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php } ?>
                                                        ...
                                                        <?php } else { ?>
                                                        <form name="marketform" id="marketform"
                                                            onsubmit="return check9();"
                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                            style="margin-top: 15px;">
                                                            <input type="hidden" name="marketpanel" value="1" />
                                                            <input type="hidden" name="marketdid"
                                                                value="<?= $viewmarket['id'] ?>" />
                                                            <div class="pmbb-edit" style="display:block;">
                                                                <dl class="dl-horizontal">
                                                                    <dt class="p-t-10">Advertisements/Advertisement
                                                                        Materials *</dt>
                                                                    <dd>
                                                                        <div class="fg-line">
                                                                            <input type="text" class="form-control "
                                                                                value="<?php echo $viewmarket['Advertisements'] ?>"
                                                                                id="Advertisements_123"
                                                                                name="Advertisements"
                                                                                placeholder="Advertisements/Advertisement Materials">
                                                                        </div>
                                                                        <span id="market_error3"
                                                                            style="color:#ff0000;">&nbsp;</span>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="dl-horizontal">
                                                                    <dt class="p-t-10">Marketing Materials or
                                                                        Information</dt>
                                                                    <dd>
                                                                        <div class="dtp-container dropdown fg-line">
                                                                            <input type="text" class="form-control "
                                                                                value="<?php echo $viewmarket['Marketing_Material'] ?>"
                                                                                id="Marketing_Material"
                                                                                name="Marketing_Material"
                                                                                placeholder="Marketing Materials or Information">
                                                                        </div>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="dl-horizontal">
                                                                    ...
                                                                    <dd>
                                                                        <div class="dtp-container dropdown fg-line">
                                                                            <input type="text" class="form-control "
                                                                                value="<?php echo $viewmarket['Commercials'] ?>"
                                                                ...
                                                                <dl class="dl-horizontal">
                                                                    ...
                                                                    <dd>
                                                                        <div class="fg-line">
                                                                            <input type="text" class="form-control "
                                                                                value="<?php echo $viewmarket['Video'] ?>"
                                                                                id="Video" name="Video"
                                                                ...
                                                                <dl class="dl-horizontal">
                                                                    ...
                                                                    <dd>
                                                                        <div class="dtp-container dropdown fg-line">
                                                                            <input type="text" class="form-control "
                                                                                value="<?php echo $viewmarket['Infomercials'] ?>"
                                                                                id="Infomercials" name="Infomercials"
                                                                                placeholder="Infomercials">
                                                                        </div>
                                                                    </dd>
                                                                </dl>
                                                                <div class="m-t-30">
                                                                    <button class="btn btn-primary btn-sm" name="submit"
                                                                        type="submit" value="marketsubmit">Save</button>
                                                                    <a href="" onclick="javascript:history.go(-1)">
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </a>
                                ...
                                <h4 id="nws" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a
                                        style="color:#FFF;">News and Information</a><i class="fa fa-plus-circle"
                                        aria-hidden="true"></i></h4>
                                <div id="news" <?php if (@$_REQUEST['newsainfopanel'] == 1) { ?>style="display:block;"
                                    ...
                                    <div class="panel panel-collapse" style="margin-bottom: 20px;">
                                        <div <?php if (@$_REQUEST['newsainfopanel'] != '') { ?>class="panel-heading active" <?php } else { ?>class="panel-heading" <?php } ?> role="tab" id="awardpanel">
                                            <h4 class="panel-title"> <a aria-expanded="true" href="#accordionTeal-news"
                                                    data-parent="#accordionTeal" data-toggle="collapse" class="">News
                                                    and Information</a> </h4>
                                        </div>
                                        <div id="accordionTeal-news" <?php if (@$_REQUEST['newsainfopanel'] != '') { ?>class="collapse in" <?php } else { ?>class="collapse" <?php } ?>
                                            role="tabpanel">
                                            <div class="panel-body">
                                                <div class="pmb-block p-10  m-b-0">
                                                    <div class="pmbb-body p-l-0">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            while ($viewnews = mysqli_fetch_array($resquerynews)) {
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?= substr(stripslashes($viewnews['newsdescription']), 0, 30) ?>
                                                                                    </td>
                                                                                    <td><?= $viewnews['linktonews'] ?></td>
                                                                                    <td><?= date('d-M-Y', strtotime($viewnews['newsdate'])) ?>
                                                                                    </td>
                                                                                    <td><?= date('jS F Y', strtotime($viewnews['lastedit'])) ?>
                                                                                    </td>
                                                                                    <!--FOR EDIT AND DELETE-->
                                                                                    <td><a
                                                                                            href="educationalinstitute.php?ind_id=<?= $viewnews['ind_id'] ?>&id=<?= $viewnews['id'] ?>&editnewsainfo=awards&accr=1&newsainfopanel=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                            onclick="return confirm('Are you sure you want to delete?');"
                                                                                            href="educationalinstitute.php?ind_id=<?= $viewnews['ind_id'] ?>&id=<?= $viewnews['id'] ?>&delnews=val&newsainfopanel=1"
                                                                                            style="color:#ff0000;">Delete</a>
                                                                                    </td>
                                                                                    <!--FOR EDIT AND DELETE-->
                                                                                </tr>
                                                                ...
                                                                <div class="pmbb-edit" style="display:block;">
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control"
                                                                                    id="newsedit" name="newsname"
                                                                                    placeholder="News Name"
                                                                                    value="<?= stripslashes($viewnews['newsname']) ?>">
                                                                            </div>
                                                                            <span id="errornews"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <textarea type='text' class="form-control"
                                                                                    ...
                                                                                    id="newsdescription"
                                                                                    data-toggle="dropdown"
                                                                                    placeholder="Description" cols="6"
                                                                                    style="height:150px;"><?= stripslashes($viewnews['newsdescription']) ?></textarea>
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type='text' class="form-control"
                                                                                    name="linktonews" data-toggle="dropdown"
                                                                                    placeholder="Link"
                                                                                    value="<?= $viewnews['linktonews'] ?>">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type='text'
                                                                                    class="form-control date-picker"
                                                                                    name="newsdate" data-toggle="dropdown"
                                                                                    value="<?= date('d-m-Y', strtotime($viewnews['newsdate'])) ?>">
                                                                            </div>
                                                                        </dd>
                                                                    </dl>
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm" name="submit"
                                                                            type="submit" value="newssubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <?php } ?>
                                                        <form name="newsform" id="newsform" onsubmit="return newsadd();"
                                                            enctype="multipart/form-data"
                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                            style="margin-top: 15px;">
                                                            <input type="hidden" name="newsainfopanel" value="1" />
                                                            <div class="pmbb-edit">
                                                                <dl class="dl-horizontal">
                                                                    ...
                                                                    <dd>
                                                                        <div class="fg-line">
                                                                            <input type="text" class="form-control"
                                                                                id="newsadde" name="newsname"
                                                                                placeholder="News Name">
                                                                        </div>
                                                                        <span id="erroranewsadd"
                                                                            style="color:#ff0000;">&nbsp;</span>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="dl-horizontal">
                                ...
                                <!--****News and Information on 17-08-2016 [SUPRATIM]****-->
                                <div>
                                    <h4 id="soc" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">Link to
                                            NarrateMe Social Network Sites</a><i class="fa fa-plus-circle"
                                            aria-hidden="true"></i></h4>
                                </div>
                                <div id="socbody" <?php if (@$_REQUEST['aff'] == 1 || @$_REQUEST['friendspanel'] == 1) { ?>style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                                    <div class="panel panel-collapse" style="margin-bottom: 20px;">
                                        <div <?php if (@$_REQUEST['friendspanel'] != '') { ?>class="panel-heading active"
                                            <?php } else { ?>class="panel-heading" <?php } ?> role="tab"
                                            id="awardpanel">
                                            <h4 class="panel-title"> <a aria-expanded="true" href="#accordionTeal-11"
                                                    data-parent="#accordionTeal" data-toggle="collapse" class="">Add
                                                    Friends/Followers</a> </h4>
                                        </div>
                                        <div id="accordionTeal-11" <?php if (@$_REQUEST['friendspanel'] != '') { ?>class="collapse in" <?php } else { ?>class="collapse" <?php } ?>
                                            role="tabpanel">
                                            <div class="panel-body">
                                                <div class="pmb-block p-10  m-b-0">
                                                    <div class="pmbb-body p-l-0">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            while ($viewfriends = mysqli_fetch_array($resquery11)) {
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?= date('jS F Y', strtotime($viewfriends['lastedit'])) ?>
                                                                                    </td>
                                                                                    <td><a
                                                                                            href="educationalinstitute.php?ind_id=<?= $viewfriends['ind_id'] ?>&id=<?= $viewfriends['id'] ?>&editfriends=awards&accr=1&friendspanel=1&soc=1">Edit</a>&nbsp;|&nbsp;<a
                                                                                            href="educationalinstitute.php?ind_id=<?= $viewfriends['ind_id'] ?>&id=<?= $viewfriends['id'] ?>&delfriends=val&friendspanel=1"
                                                                                            style="color:#ff0000;">Delete</a>
                                                                                    </td>
                                                                                </tr>
                                                                            <?php } ?>
                                                        ...
                                                        <?php } else { ?>
                                                            <form name="friendsform" id="friendsform"
                                                                onsubmit="return check9();"
                                                                action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                                style="margin-top: 15px;">
                                                                <input type="hidden" name="friendspanel" value="1" />
                                                                <input type="hidden" name="friendsdid"
                                                                    value="<?= $viewfriends['id'] ?>" />
                                                                <div class="pmbb-edit" style="display:block;">
                                                                    <dl class="dl-horizontal">
                                                                        <dt class="p-t-10">Name*</dt>
                                                                        <dd>
                                                                            <div class="fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewfriends['name'] ?>"
                                                                                    id="name888" name="name"
                                                                                    placeholder="Name">
                                                                            </div>
                                                                            <span id="friends_error3"
                                                                                style="color:#ff0000;">&nbsp;</span>
                                                                        </dd>
                                                                    </dl>
                                                                    <dl class="dl-horizontal">
                                                                        ...
                                                                        <dd>
                                                                            <div class="dtp-container dropdown fg-line">
                                                                                <input type="text" class="form-control "
                                                                                    value="<?php echo $viewfriends['link'] ?>"
                                                                                    id="link" name="link"
                                                                    ...
                                                                    <div class="m-t-30">
                                                                        <button class="btn btn-primary btn-sm" name="submit"
                                                                            type="submit"
                                                                            value="friendssubmit">Save</button>
                                                                        <button data-pmb-action="reset"
                                                                            class="btn btn-link btn-sm">Cancel</button>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <?php } ?>
                                                        <form name="friendsform" id="friendsform"
                                                            onsubmit="return Submitfriends3();"
                                                            action="<?= $_SERVER['PHP_SELF'] ?>" method="post"
                                                            style="margin-top: 15px;">
                                                            <input type="hidden" name="friendspanel" value="1" />
                                                            <div class="pmbb-edit">
                                ...
                                <div>
                                    ...
                                    <h4 class="btn btn-success"><a
                                            href="http://localhost/narrateme/course-module/supercontrol/home/<?php echo $uri; ?>"
                                            style="cursor:pointer; color:#FFF;">Upload Courses</a><i
                                            class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                                </div>
                            </div>
                        </div>
