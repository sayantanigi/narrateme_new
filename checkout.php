                                                ...
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <button type="submit" name="payment" class="btn btn-primary btn-submit-fix" style="background: #576042; padding: 0 20px; height: 40px; border-radius: 50px; font-size: 14px;">Place Order</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
