                                    ...
                                    if (!empty($ecms)) {
                                        foreach ($ecms as $i) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <!-- <td><a href="" class="btn green btn-sm btn-outline sbold uppercase">Comments</a> -->
                                                </td>
                                                <td>
                                                    <?php if ($i->status == 1) { ?>
                                                ...
                                                <td><a class="btn green btn-sm btn-outline sbold uppercase"
                                                        href="<?php echo base_url() ?>audio/show_audio_id/<?php echo $i->id ?>">Edit</a>
                                                </td>
                                                <td><a class="btn green btn-sm btn-outline sbold uppercase"
                                                        href="<?php echo base_url() ?>audio/delete_audio/<?php echo $i->id ?>"
