                    ...
                    <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-body form">
                            <?php foreach ($ecms as $i) { ?>
                                <form method="post" class="form-horizontal form-bordered" action="<?php echo base_url() ?>cms/edit_cms_individual" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="text" class="form-control" name="meta_keywords" id="meta_keywords" value="<?php echo $i->meta_keywords; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <?php
                                                $file = array('type' => 'file', 'name' => 'page_image', 'onchange' => 'readURL(this);');
                                                echo form_input($file);
                                                ?>
                                                <div id='default_img'><img id="select" src="<?php echo base_url() ?>/uploads/cms/<?php echo $i->cmsimg; ?>" alt="your image" style="width:190px; margin-top: 10px;" /></div>
