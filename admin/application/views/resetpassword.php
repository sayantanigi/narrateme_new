                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-body form">
                            ...
                            <h3 class="form-title font-green" style="font-weight:300 !important;"><i
                                    class="fa fa-user"></i> Reset Password</h3>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control small_control_field form-control-solid placeholder-no-fix"
                                    type="password" autocomplete="off" placeholder="Old Password" name="old_password" />
                            </div>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">New Password</label>
                                <input class="form-control small_control_field form-control-solid placeholder-no-fix"
                                    type="password" autocomplete="off" placeholder="New Password" name="newpassword" />
                            </div>
                            <div class="form-group">
