                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            ?>
                                                            <div id='default_img'>
                                                                <img id="select" src="<?php echo base_url() ?>uploads/product_type/<?php echo $i->product_type_image; ?>" alt="your image" style="width: 150px; margin-top: 10px;" />
                                                            </div>
                                                            <input type="hidden" id="old_image" name="old_image" value="<?= $i->product_type_image?>"?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
