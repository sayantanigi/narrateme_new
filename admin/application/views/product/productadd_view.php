                            ...
                            <div class="tab-pane active" id="tab_0">
                                <div class="portlet box blue-hoki">
                                    ...
                                    <div class="portlet-body form">
                                        <form action="<?php echo base_url() . 'product/add_product' ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_input(array('id' => 'product_name', 'name' => 'product_name', 'class' => 'form-control')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_input(array('id' => 'price', 'name' => 'price', 'class' => 'form-control')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_input(array('id' => 'discount', 'name' => 'discount', 'class' => 'form-control')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_input(array('id' => 'quantity', 'name' => 'quantity', 'class' => 'form-control')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_textarea(array('id' => 'pagedes', 'name' => 'description', 'class' => 'form-control')); ?>
