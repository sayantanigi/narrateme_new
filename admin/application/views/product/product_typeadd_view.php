                            ...
                            <div class="tab-pane active" id="tab_0">
                                <div class="portlet box blue-hoki">
                                    ...
                                    <div class="portlet-body form">
                                        <form action="<?php echo base_url() . 'product_type/add_product_type' ?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_input(array('id' => 'product_type_title', 'name' => 'product_type_title', 'class' => 'form-control')); ?>
