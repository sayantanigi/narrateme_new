                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <?php foreach ($ecms as $i) { ?>
                                            <form method="post" class="form-horizontal form-bordered"
                                                action="<?php echo base_url() . 'index.php/product/edit_product ' ?>"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <b> <label class="col-md-3 control-label">Product Type *</label>
                                                        </b>
                                                        <div class="col-md-9">
                                                            <select name="product_type" id="product_type"
                                                                ...
                                                                foreach ($ecat as $a) {
                                                                    ?>
                                                                    <option value="<?php echo $a->id; ?>" <?php if ($a->id == $i->categori_id) { ?> selected="selected" <?php } ?>>
                                                                        <?php echo $a->product_type_title ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            ?>
                                                            <div id='default_img'><img id="select"
                                                                    src="<?php echo base_url() ?>uploads/product/<?php echo $i->product_image; ?>"
                                                                    alt="your image" style="width:150px; margin-top: 10px;" /></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="product_name"
                                                                value="<?php echo $i->product_name; ?>" name="product_name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9"> <input type="text" class="form-control"
                                                                id="price" value="<?php echo $i->price; ?>" name="price">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9"> <input type="text" class="form-control"
                                                                id="discount" value="<?php echo $i->discount; ?>"
                                                                name="discount">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9"> <input type="text" class="form-control"
                                                                id="quantity" value="<?php echo $i->quantity; ?>"
                                                                name="quantity">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control" name="description" rows="6"
                                                                id="pagedes"><?php echo $i->description; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
