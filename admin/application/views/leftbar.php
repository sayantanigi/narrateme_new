    ...
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
        ...
        <li class="nav-item <?php if ($nl == "banner") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle">
                <i class="icon-docs"></i> <span class="title">Banner Mgmt</span>
                <span class="addmember"></span>
                <span class="arrow addmember"></span>
            </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl2 == "add_banner") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>banner/add_banner" class="nav-link ">
                        <span class="title">Add Banner </span>
                    </a>
                </li>
                <li class="nav-item  <?php if ($nl == "banner" && $nl2 != "add_banner") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>banner/view_banner" class="nav-link "> <span class="title">Manage banner</span> </a>
                </li>
            </ul>
        </li>
        <li class="nav-item <?php if ($nl == "cms") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl2 == "add_cms") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>cms/add_cms" class="nav-link ">
                        <span class="title">Add Cms Page </span>
                    </a>
                </li>
                <li class="nav-item  <?php if ($nl == "cms" && $nl2 != "add_cms") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>cms" class="nav-link "> <span class="title">Manage CMS Page</span> </a>
                </li>
            </ul>
        </li>
        <li class="nav-item <?php if ($nl == "faq") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item  <?php if ($nl == "faq" && $nl2 != "add_faq") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>faq/view_faq" class="nav-link "> <span class="title">Manage FAQ</span> </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item <?php if ($nl == "member") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                <li class="nav-item <?php if ($nl == "member" && $nl2 != "view_member" && $nl2 != "view_drug" && $nl2 != "add_drug_view") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>member" class="nav-link "> <span class="title">Add member</span>
                    </a>
                </li>
                <li class="nav-item <?php if ($nl2 == "view_member") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>member/view_member" class="nav-link ">
        ...
        <li class="nav-item <?php if ($nl == "newsmedia") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                <li class="nav-item <?php if ($nl == "newsmedia" && $nl2 != "view_newsmedia") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>newsmedia" class="nav-link ">
                        <span class="title">Add News Media</span>
                    </a>
                </li>
                <li class="nav-item <?php if ($nl2 == "view_newsmedia") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>newsmedia/view_newsmedia" class="nav-link ">
                        <span class="title">Manage News Media </span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item <?php if ($nl == "social") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                <li class="nav-item <?php if ($nl == "social" && $nl2 != "view_social") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>social" class="nav-link ">
                        <span class="title">Add Social Profile</span>
                    </a>
                </li>
                <li class="nav-item  <?php if ($nl2 == "view_social") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>social/view_social" class="nav-link ">
                        <span class="title">Manage Social Profile </span>
                    </a>
                </li>
            </ul>
        </li>
        <!--li class="nav-item <?php if ($nl == "student" || $nl == "studentaward") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle">
                <i class="icon-docs"></i>
                <span class="title">Student Mgmt</span>
                <span class="<?//=$selected['addsocialprofile'] ?>"></span>
                <span class="arrow <?//=$arrowopen['addsocialprofile'] ?>"></span>
            </a>
            <ul class="sub-menu">
                <li class="nav-item <?php if ($nl == "student" && $nl2 != "view_student" && $nl2 != "view_student_experience" && $nl2 != "add_rehabdata_view") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>student" class="nav-link ">
                        <span class="title">Add Student Profile</span>
                    </a>
                </li>
                <li class="nav-item <?php if ($nl2 == "view_student") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>student/view_student" class="nav-link ">
                        <span class="title">Manage Student Profile </span>
                    </a>
                </li>
        ...
        <!--<li class="nav-item <?php if ($nl == "institute" || $nl == "teacher") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle">
                <i class="icon-docs"></i>
                <span class="title">Institute Mgmt</span>
        ...
        <!--<li class="nav-item <?php if ($nl == "recomendation" || $nl == "teacher") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle">
                <i class="icon-docs"></i>
                <span class="title">Recommendation Mgmt</span>
                <span class="<?//=$selected['edu'] ?>"></span>
                <span class="arrow <?//=$arrowopen['edu'] ?>"></span>
            </a>
            <ul class="sub-menu">
        ...
        <!--<li class="nav-item <?php if ($nl == "coach") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle">
                <i class="icon-docs"></i>
                <span class="title">Coach Mgmt</span>
                <span class="<?//=$selected['edu'] ?>"></span>
                <span class="arrow <?//=$arrowopen['edu'] ?>"></span>
            </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "video") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                <li class="nav-item <?php if ($nl == "video" && $nl2 != "view_video") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>video" class="nav-link ">
                        <span class="title">Add video</span>
                    </a>
                </li>
                <li class="nav-item <?php if ($nl2 == "view_video") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>video/view_video" class="nav-link ">
        ...
        <li class="nav-item <?php if ($nl == "audio") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                <li class="nav-item <?php if ($nl == "audio" && $nl2 != "view_audio") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>audio" class="nav-link ">
                        <span class="title">Add audio</span>
                    </a>
                </li>
                <li class="nav-item <?php if ($nl2 == "view_audio") { ?>active open<?php } ?>">
                    <a href="<?php echo base_url() ?>audio/view_audio" class="nav-link ">
                        <span class="title">Manage Audio </span>
                    </a>
                </li>
            </ul>
        </li>
