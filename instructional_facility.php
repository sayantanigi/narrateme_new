          ...
          <div class="pmb-block">
            <div class="pmbb-header">
              <div class="panel-group" data-collapse-color="teal" id="accordionTeal" role="tablist" aria-multiselectable="true">
                ...
                <h4 id="if" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a style="color:#FFF; cursor:pointer;">Information</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                          ...
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editfacilities'] == '') { ?>
                              <div class="pmbb-view">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return block();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <?php if (@$_REQUEST['editform'] == 1) { ?>
                                  <div>
                                    <form name="abc" id="abc" onsubmit="return kkk();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                    ...
                                    <table class="table table-striped table-bordered table-advance table-hover" width="50%">
                                      ...
                                      <tbody>
                                        ...
                                        ?>
                                          ...
                                          <!--Under Add Show-->
                                          <tr style="display:none; background-color:#576042;" id="bottomtr<?php echo $viewfacilities['id'] ?>">
                                            <td colspan="10">
                            ...
                            <?php } else { ?>
                              <form name="facilitiesform" id="facilitiesform" onsubmit="return check9();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="facilities_error" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="facilitiesform" id="facilitiesform" onsubmit="return Submitfacilities3();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="facilitiespanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Name*</dt>
                ...
                <h4 id="sd" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Schools/Divisions</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                          ...
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editschools'] == '') { ?>
                              <div class="pmbb-view">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return block123();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcoursesandclasses" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                ...
                                <?php if (@$_REQUEST['editcourseandclassform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block234();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="error1122" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                ...
                                <?php if (@$_REQUEST['addinstrucrsdetails'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block345();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errordesorsyl" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                ...
                                <?php if (@$_REQUEST['editcrsdetform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block567();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errordesorsyl1" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Instructor</dt>
                                  ...
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      <select class="form-control" name="program" id="program">
                                        ...
                                        <option value="diploma" name="diploma" <?php if ("diploma" == $viewschools['program']) {
                                                                                  echo 'selected';
                                                                                } ?>>Diploma</option>
                                        <option value="certificate" name="certificate" <?php if ("certificate" == $viewschools['program']) {
                                                                                          echo 'selected';
                                                                                        } ?>>Certificate</option>
                                        <option value="rankorlevel" name="rankorlevel" <?php if ("rankorlevel" == $viewschools['program']) {
                                                                                          echo 'selected';
                                                                                        } ?>>Rank or Level</option>
                                        <option value="continuingeducation" name="continuingeducation" <?php if ("continuingeducation" == $viewschools['program']) {
                                                                                                          echo 'selected';
                                                                                                        } ?>>Continuing Education</option>
                                      </select>
                                      <span id="schoolserror" style="color:#F00;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="schoolsform" id="schoolsform" enctype="multipart/form-data" onsubmit="return Submitschools3();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="schoolspanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Program*</dt>
                                  <dd>
                                    ...
                                    <span id="schools_error3" style="color:#F00;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Course/Program Bulletin</dt>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editlectures'] == '') { ?>
                              <div class="pmbb-view">
                                ...
                                <?php if (@$_REQUEST['editleclinkform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block1();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorrr" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to live camera/microphone</dt>
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return block2();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to recorded video/audio*</dt>
                                        <dd>
                                          ...
                                          <span id="error11" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to live camera/microphone</dt>
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return block3();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errora" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to live camera/microphone</dt>
                                ...
                                <?php if (@$_REQUEST['addinstruarccls'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block4();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to recorded video/audio*</dt>
                                        <dd>
                                          ...
                                          <span id="error5" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                ...
                                <?php if (@$_REQUEST['editlecarcclsform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block5();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorarc" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                            ...
                            <?php } else { ?>
                              <form name="lecturesform" id="lecturesform" onsubmit="return check9();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="lectures_error3" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="lecturesform" id="lecturesform" onsubmit="return Submitlectures3();" enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="lecturespanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Videos of classes*</dt>
                ...
                <h4 id="asd" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Affiliate Schools/Divisions</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                          ...
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editaffiliateschools'] == '') { ?>
                              <div class="pmbb-view">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return cocu();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="error_courses" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return cocu1();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="error_courses1" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                ...
                                <?php if (@$_REQUEST['addinstrucourcur'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block789();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorsyllabus" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Course/Class/Lecture Schedule</dt>
                                ...
                                <?php if (@$_REQUEST['editcourafscform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return block221();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorsyllabus1" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Course/Class/Lecture Schedule</dt>
                            ...
                            <?php } else { ?>
                              <form name="affiliateschoolsform" id="affiliateschoolsform" onsubmit="return check9();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                  ...
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      <div class="fg-line">
                                        <select class="form-control" name="program" id="program">
                                          <option value="">Please Select</option>
                                          <option value="diploma" <?php if ("diploma" == $viewaffiliateschools['program']) {
                                                                    echo 'selected';
                                                                  } ?>>Diploma</option>
                                          <option value="certificate" <?php if ("certificate" == $viewaffiliateschools['program']) {
                                                                        echo 'selected';
                                                                      } ?>>Certificate</option>
                                          <option value="degree" <?php if ("degree" == $viewaffiliateschools['program']) {
                                                                    echo 'selected';
                                                                  } ?>>Degree</option>
                                        </select>
                                      </div>
                            ...
                            <?php } ?>
                            <form name="affiliateschoolsform" id="affiliateschoolsform" enctype="multipart/form-data" onsubmit="return Submitaffiliateschools3();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="affiliateschoolspanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Academic Programs*</dt>
                          ...
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editaffiliateschools'] == '') { ?>
                              <div class="pmbb-view">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return addinstrulecafsc();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to recorded video/audio*</dt>
                                        <dd>
                                          ...
                                          <span id="errorafsc" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to live camera/microphone</dt>
                                ...
                                <?php if (@$_REQUEST['editleclinkafscform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return editleclinkafscform();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return addinstrusubclsafsc();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to recorded video/audio*</dt>
                                        <dd>
                                          ...
                                          <span id="errorafsc1" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to live camera/microphone</dt>
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return editlecsubclsafscform();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="facilitiesteacherpanel" value="1" />
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorafsc2" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to live camera/microphone</dt>
                                ...
                                <?php if (@$_REQUEST['addinstruarcclsafsc'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return addinstruarcclsafsc();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to recorded video/audio*</dt>
                                        <dd>
                                          ...
                                          <span id="erroraddinstruarcclsafsc" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                ...
                                <?php if (@$_REQUEST['editlecarcclsafscform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return editlecarcclsafscform();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditlecarcclsafscform" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                            ...
                            <?php } else { ?>
                              <form name="affiliateschoolslectureform" id="affiliateschoolslectureform" onsubmit="return blankvalidation();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="lecturesafsclecedit" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                                    <dt class="p-t-10">Accepted Substitute Classes</dt>
                            ...
                            <?php } ?>
                            <form name="affiliateschoolslectureform" id="affiliateschoolslectureform" enctype="multipart/form-data" onsubmit="return validation();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="affiliateschoolslecturepanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Videos of classes*</dt>
                                  <dd>
                                    ...
                                    <span id="lecturesafsclec" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Accepted Substitute Classes</dt>
                ...
                <h4 id="stu" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Students</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                          ...
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editstudents'] == '') { ?>
                              <div class="pmbb-view">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return addtransforstu();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorstuidfortranscript" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                ...
                                <?php if (@$_REQUEST['edittranscriptform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return edittranscriptform();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorstuidfortranscriptedit" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Courses/Classes taken</dt>
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return addcoursetaken();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorgradescore" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return editcourtakform();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorgradescoreedit" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Course/Class Attendance</dt>
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return addcourseenrol();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Grade(s)/Scores/Achievements*</dt>
                                        <dd>
                                          ...
                                          <span id="errorgradescoreenrol" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Course/Class Attendance</dt>
                                ...
                                <?php if (@$_REQUEST['editcourenrform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return editcourenrform();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorgradescoreenroledit" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Course/Class Attendance</dt>
                            ...
                            <?php } else { ?>
                              <form name="studentsform" id="studentsform" onsubmit="return blankvalidationedit();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="errorcurstued" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="studentsform" id="studentsform" onsubmit="return validationstudent();" enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="studentspanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Current Students*</dt>
                                  <dd>
                                    ...
                                    <span id="errorcurstu" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Past Students</dt>
                ...
                <h4 id="map" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Marketing and Promotion</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                            ...
                            <?php } else { ?>
                              <form name="marketingform" id="marketingform" onsubmit="return maekrtingedit();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="erroradvertisementedit" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="marketingform" id="marketingform" enctype="multipart/form-data" onsubmit="return marketing();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="marketingpanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Advertisements/Advertisement Materials*</dt>
                                  <dd>
                                    ...
                                    <span id="erroradvertisement" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Marketing Materials or Information</dt>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                            ...
                            <?php } ?>
                            <form name="newsform" id="newsform" onsubmit="return newsadd();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="newsainfopanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">News Name*</dt>
                ...
                <h4 id="sns" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Link to NarrateMe Social Network Site</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                          ...
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editsocial'] == '') { ?>
                              <div class="pmbb-view">
                                ...
                                ?>
                                  <div>
                                    <form onsubmit="return addsocialdet();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      <input type="hidden" name="id" value="<?= $_REQUEST['id'] ?>" />
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Name*</dt>
                                        <dd>
                                          ...
                                          <span id="errorsocialname" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                ...
                                <?php if (@$_REQUEST['editsocialform'] == 1) { ?>
                                  <div>
                                    <form onsubmit="return editsocialform();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditnamede" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <dl class="dl-horizontal">
                                        <dt class="p-t-10">Link to Page</dt>
                            ...
                            <?php } else { ?>
                              <form name="socialform" id="socialform" onsubmit="return editsocial();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="errorfriendsfollowersedit" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <div class="m-t-30">
                            ...
                            <?php } ?>
                            <form name="socialform" id="socialform" onsubmit="return social();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="socialpanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Friends or Followers*</dt>
                                  <dd>
                                    ...
                                    <span id="errorfrndfler" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <div class="m-t-30">
                                  <button class="btn btn-primary btn-sm" name="submit" type="submit" value="socialsubmit">Save</button>
