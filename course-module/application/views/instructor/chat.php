    ...
    foreach ($myprofile as $mf) {
        ...
        <div id="page-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"> <span class="glyphicon glyphicon-comment"></span> Chat With
                                        Admin
          ...
          <?php }
            ...
            <?php if (!empty($userchat)) {
                foreach ($userchat as $us) { ?>
                                                ...
                                                foreach ($allchat as $all) { ?>
                                                    <?php if ($all->admin_id != 0) { ?>
                                                        <li class="left clearfix"><span class="chat-img pull-left"> <img
                                                            ...
                                                            <div class="chat-body clearfix">
                                                                <div class="header"> <strong class="primary-font">Admin</strong> <small
                                                    ...
                                                    <?php } else { ?>
                                                        <li class="right clearfix"><span
                                                                class="chat-img pull-right"><?php if (!empty($myprofile)) { ?> <img
                                                                        style="width:50px; height:50px;"
                                                                        src="<?php echo base_url() ?>uploads/profile/<?php echo $myprofile[0]->profile_image ?>"
                                                                        alt="User Avatar" class="img-circle" /><?php } else { ?><img
                                                                        style="width:50px; height:50px;"
                                                                        src="http://placehold.it/50/FA6F57/fff&text=ME" alt="User Avatar"
                                                                        class="img-circle" /> <?php } ?> </span>
                                                            <div class="chat-body clearfix">
