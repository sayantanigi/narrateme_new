    ...
    <input type="search" class="dgwt-wcas-search-input" name="" value="" placeholder="Search">
            ...
            <div class="nav-header">
                <div class="container">
                    <div class="row">
                        <div class="col-2">
                            <div class="top-logo"><a href="https://projects.goigi.biz/narrateme/index.php"><img src="<?= base_url(); ?>user_panel/new/images/logo.png" alt=""></a></div>
                        </div>
                        <div class="col-10">
                                    ...
                                    <div class="menu-bar">
                                        ...
                                        <div class="navbar-collapse iphonNav nav-top clearfix collapse navigation" id="myNavbar" style="display: block;">
                                            ...
                                            <div class="menu-top-menu-container">
                                                <ul>
                                                    <li><a href="https://projects.goigi.biz/narrateme/index.php">Home</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/page.php?id=17">About Us</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/page.php?id=18">Members</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/page.php?id=19">Individuals</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/php?id=20">Students</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/page.php?id=21">Educational Institutions</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/page.php?id=22">Instructional Facilities &amp; Schools</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/product_list.php">Products</a></li>
                                                    <li><a href="<?php echo base_url('courses') ?>">Courses</a></li>
                                                    <li><a href="https://projects.goigi.biz/narrateme/contact.php?id=5">Contact Us</a></li>
                                                </ul>
