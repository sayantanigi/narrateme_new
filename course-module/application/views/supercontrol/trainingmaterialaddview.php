                            ...
                            <div class="tab-pane active" id="tab_0">
                                <div class="portlet box blue-hoki">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="<?php echo base_url() . 'supercontrol/course/add_course_trainingmaterial' ?>"
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            ...
                                                            <div> <span class="btn default btn-file"> <span
                                                                        class="fileinput-new"> Select PDF </span> <span
                                                        ...
                                                        <div class="clearfix margin-top-10"> <span
                                                                class="label label-danger">Format</span>
                                                            pdf,doc,docx,ppt,txt </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        <input type="hidden" name="course_id"
                                                            value="<?php echo end($this->uri->segment_array()); ?>" />
