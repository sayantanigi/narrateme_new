                                    ...
                                    <div class="portlet-body form">
                                        <?php foreach ($course as $c) { ?>
                                            <form action="<?php echo base_url().'supercontrol/course/edit_course' ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group"><b><label class="col-md-3 control-label">Select Category *</label></b>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <div id='default_img'>
                                                                ...
                                                                <img id="select" src="<?php echo base_url() ?>uploads/courseimage/<?php echo $c['course_image']; ?>" alt="your image" style="width:150px;" />
                                                                <?php } else { ?>
                                                                <img id="select" src="<?php echo base_url() ?>uploads/no_image.png" alt="your image" style="width:150px; margin-top: 15px;" />
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="old_image" value="<?php echo $c['course_image']; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group"><label class="col-md-3 control-label"><b>Price *</b></label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label"><b>Start Date *</b></label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label"><b>End Date *</b></label>
                                                        <div class="col-md-8">
