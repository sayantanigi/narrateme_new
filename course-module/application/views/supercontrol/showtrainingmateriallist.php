        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Show Training Material List</span>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="tab-pane active" id="tab_0">
                                <div class="portlet box blue-hoki">
                                    <div class="portlet-title">
                                        <div class="caption"> <i class="fa fa-gift"></i>Show Training Material List
                                        </div>
                                        <div class="tools">
                                                        ...
                                                        foreach ($syllabuslist as $i) { ?>
                                                            <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a
                                                                        href="<?php echo site_url('uploads/trainingmaterial/' . $i->training_material_files); ?>">
                                                                ...
                                                                <td style="max-width:200px;">
                                                                    <?php echo $i->training_material_name; ?>
                                                                </td>
                                                                <td style="max-width:50px;">
                                                                    <a class="btn green btn-sm btn-outline sbold uppercase"
                                                                        href="<?php echo base_url() ?>supercontrol/course/edit_trainingmaterial_view/<?php echo $i->training_material_id; ?>">Edit</a>
                                                                </td>
                                                                <td style="max-width:50px;">
                                                                    <a class="btn red btn-sm btn-outline sbold uppercase"
                                                                        onclick="return confirm('Are you you want to  delete?');"
                                                                        href="<?php echo base_url() ?>supercontrol/course/delete_trainingmaterial/<?php echo $i->training_material_id; ?>">Delete</a>
                                                                </td>
                                                            </tr>
                                                            <?php $ctn++;
                                                        } ?>
