                                                ...
                                                if (count($userlist) > 1) {
                                                    foreach ($userlist as $i) {
                                                        ...
                                                        <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive"
                                                            ...
                                                            <td width="60" style="max-width:190px;">
                                                                <?php echo $i->schedule_title; ?></td>
                                                            ...
                                                            <td>
                                                                <select id="status"
                                                                    onchange="changestatus(this.value, <?= $i->id; ?>);">
                                                                    <option value="Yes" <?php if ($i->approved == "Yes") {
                                                                        echo 'selected';
                                                                    } ?>>Yes</option>
                                                                    <option value="No" <?php if ($i->approved == "No") {
                                                                        echo 'selected';
                                                                    } ?>>No</option>
                                                                </select>
                                                            </td>
                                                            ...
                                                            <td style="max-width:50px;"><a
                                                                    onclick="deleteone(<?php echo $i->id; ?>);"
