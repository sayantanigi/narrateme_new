    ...
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
        ...
        <li class="nav-item <?php if ($nl == "course" || $nl == "batch" || $nl == "lesson") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item <?php if ($nl2 == "course") { ?>active open<?php } ?>"> <a href="<?php echo base_url(); ?>supercontrol/batch/add_instructor" class="nav-link "> <span class="title">Create Course Meeting Link</span> </a> </li>
                <li class="nav-item <?php if ($nl2 == "course") { ?>active open<?php } ?>"> <a href="<?php echo base_url(); ?>supercontrol/batch/instructor_list" class="nav-link "> <span class="title">Course Meeting Link List</span> </a> </li>
