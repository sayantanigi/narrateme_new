                                        ...
                                        <?php foreach ($lessdetails as $i) { ?>
                                            <form action="<?php echo base_url().'supercontrol/batch/edit' ?>" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="check()">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <b><label class="col-md-3 control-label">Total hours *</label></b>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div id="startdate">
                                                        <?php $ctb = 1;
                                                        foreach ($batchSessionlist as $j) { ?>
                                                        <div class="form-group">
                                                            <b><label class="col-md-3 control-label">Session <?php echo $ctb; ?> Date *</label></b>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group">
                                                            <b><label class="col-md-3 control-label">Session <?php echo $ctb; ?> Start Time *</label></b>
                                                            <div class="col-md-8">
                                                                <input type="time" class="form-control" value="<?php echo $j->starttime; ?>" name="starttime[]" required="required">
                                                                <label id="errorBox"></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <b><label class="col-md-3 control-label">Session <?php echo $ctb; ?> End Time *</label></b>
                                                            <div class="col-md-8">
                                                                <input type="time" class="form-control" value="<?php echo $j->endtime; ?>" name="endtime[]" required="required">
                                                                <label id="errorBox"></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <b><label class="col-md-3 control-label">Session <?php echo $ctb; ?> Time Type *</label></b>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group">
                                                            <b><label class="col-md-3 control-label">Session <?php echo $ctb; ?> Session Objective *</label></b>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group">
                                                            <b><label class="col-md-3 control-label">Session <?php echo $ctb; ?> Location *</label></b>
                                                            <div class="col-md-8">
                                                                <select name="session_location[]" class="form-control">
                                                                    <option>-- Select Location --</option>
                                                                    <?php if (!empty($locations)) {
                                                                    foreach ($locations as $ls) { ?>
                                                                    <option value="<?= $ls->id ?>" <?php if($ls->id == $j->session_location) { echo "selected"; } ?>><?= $ls->name ?></option>
                                                                    <?php }} ?>
                                                                </select>
