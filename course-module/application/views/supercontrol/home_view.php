        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li><a style="pointer-events:none;" href="<?php base_url(); ?>supercontrol/home">Home</a><i
            ...
            <a class="more" href="<?php echo base_url(); ?>supercontrol/course/show_course"> View more <i class="m-icon-swapright m-icon-white"></i> </a> </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red">
                        ...
                        <a class="more" href="<?php echo base_url(); ?>supercontrol/course/show_course"> View more <i
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red">
                        ...
                        <a class="more" href="<?php echo base_url(); ?>supercontrol/home"> View more <i
                                class="m-icon-swapright m-icon-white"></i> </a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
